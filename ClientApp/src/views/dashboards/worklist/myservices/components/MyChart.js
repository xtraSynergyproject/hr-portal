...
const data = [
  { name: 'reject', value:65, color: '#00d4bd' },
  { name: 'completed', value: 33, color: '#ffe700' },
  { name: 'pending', value: 16, color: '#FFA1A1' },
]
...
const MyChart = () => {
  return (
      <>
    <Box></Box>
    <Typography variant='h6' component='h2' sx={{ml:40,}}>Core HR</Typography>
    <Card  sx={{width:'26rem',height:'34vh',border:'1px solid grey',mt:4,ml:2}}>
      ...
      <CardContent>
        ...
        {/* <Box> */}
         <Typography variant='h6' component='h2'textAlign={'center'}>119</Typography>
          Total Task(s)
         {/* </Box> */}
        </Box>
         
        <Box sx={{ height:'10rem',width:'10rem',mt:-40, ml:50, border:'1px solid'}}>
           <ResponsiveContainer>
            <PieChart height={350} >
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', mt: 1,ml:35,border:'1px solid '}}>
          <Box
            sx={{
              mr: 1,
              display: 'flex',
