...
const SidebarLeft = ({ direction }) => {
  ...
  return (
    <Box sx={{ m: 3, width: '250px' }}>
      <Box>
        <Button variant='text' color='primary' size='medium' sx={{ textTransform: 'capitalize' }}  startIcon={<Icon icon='mdi:inbox' />}>
          Home
        </Button>
        <br />
        <Button variant='text' color='secondary' size='medium' sx={{ textTransform: 'capitalize' }} startIcon={<Icon icon='mdi:calendar-alert' />}>
           PendingTillToday
        </Button>
        <br />
        <Button variant='text' color='secondary' size='medium' sx={{ textTransform: 'capitalize' }} startIcon={<Icon icon='mdi:calendar-search' />}>
           EndinginNext7days
        </Button>
        <br />
