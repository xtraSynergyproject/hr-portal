...
export default function BasicModal() {
    ...
    return (
        ...
        <div>
            ...
            <Box component='span' sx={{ '& button': { m: 3, backgroundColor: '#000000' } }}>

                <Button size="small" variant='contained' sx={{ textTransform: 'capitalize' }} onClick={handleOpen}>+Create Task</Button>
