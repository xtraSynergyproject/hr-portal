...
const columns = [
  {
    flex: 0.2,
    minWidth: 200,
    field: 'Create/Edit Roster Schedule.',
    headerName: 'Create/Edit Roster Schedule.'
    // renderCell: ({ row }) => {
  ...
  {
    flex: 0.2,
    field: 'Copy This Roster',
    headerName: 'Copy This Roster',
    minWidth: 200
    // renderCell: ({ row }) => {
    //   return (
    //     <Box sx={{ display: 'flex', alignItems: 'center' }}>
  ...
  {
    flex: 0.2,
    field: 'RosterTimeLine View',
    headerName: 'Roster TimeLine View',
    minWidth: 200
    // renderCell: ({ row }) => {
    //   return (
    //     <Box sx={{ display: 'flex', alignItems: 'center' }}>
  ...
  {
    flex: 0.2,
    field: 'Leave Calender View',
    headerName: 'Leave Calender View',
    minWidth: 200
    // renderCell: ({ row }) => {
    //   return (
    //     <Box sx={{ display: 'flex', alignItems: 'center' }}>
...
const EducationalReimbTable = ({ apiData }) => {
  // ** State
...
export default EducationalReimbTable
