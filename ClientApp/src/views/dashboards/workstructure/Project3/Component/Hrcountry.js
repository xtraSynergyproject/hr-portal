...
function createData(CountryName,Code,DialCode,CreatedBy,CreatedDate,LastUpdatedBy,LastUpdatedDate){
  return createData(CountryName,Code,DialCode,CreatedBy,CreatedDate,LastUpdatedBy,LastUpdatedDate)
}
...
const UserList = ({ apiData }) => {
 ...
 const [addUserOpen, setAddUserOpen] = useState(false)
  ...
  const viewData=async()=>{
    let response = await axios.get(`https://webapidev.aitalkx.com/CHR/query/LoadNoteIndexPageGrid?indexPageTemplateId=a5d2e090-4d79-454f-86bb-0af9b9fdfcb4&userId=45bba746-3309-49b7-9c03-b579336`)
