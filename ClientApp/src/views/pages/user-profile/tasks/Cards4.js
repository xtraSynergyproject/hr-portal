...
const BorderLinearProgress = styled(LinearProgress)(({ theme }) => ({
  height: 10,
  borderRadius: 5,
  [`&.${linearProgressClasses.colorInherit}`]: {
    backgroundColor: theme.palette.grey[theme.palette.mode === 'light' ? 2 : 80]
  },
...
const CardMembership = () => {
  return (
    <Card sx={{ height: '32vh', maxWidth: '15rem' }}>
      <Grid container sx={{ padding: '1px', gap: '2px', mt: '9px' }}>
        <Grid item xs={12} sm={12}>
          ...
          <CardContent>
            <Typography fontSize='12px'>
              <b>Approve New Department Request</b>
            </Typography>
