...
//     return{OpenRequestCount, SLAViolated, ServiceApproachingViolationInaMin, ServiceApproachingViolation
...
//                                 <Typography variant='caption'>{title}Stock</Typography>
...
//                             </Avatar>
//                             <Box sx={{ display: 'flex', flexDirection: 'column' }}>
//                                 <Typography variant='caption'>{title}up</Typography>
//                                 <Box sx={{ mt: 0.5, display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
//                                     <Typography variant='h6' sx={{ mr: 1, fontWeight: 600, lineHeight: 1.05 }}>
...
//                             </Avatar>
//                             <Box sx={{ display: 'flex', flexDirection: 'column' }}>
//                                 <Typography variant='caption'>{title}down</Typography>
//                                 <Box sx={{ mt: 0.5, display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
//                                     <Typography variant='h6' sx={{ mr: 1, fontWeight: 600, lineHeight: 1.05 }}>
