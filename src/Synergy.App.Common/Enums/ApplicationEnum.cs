...
namespace Synergy.App.Common
{
    ...
    public enum ListViewScrollableMode
    {
        Endless = 0
    }
    public enum ListViewSelectionMode : int
    {
        Single = 0,
        Multiple = 1
    }
    ...
    public enum ProjectPropsalResponseEnum : int
    {
        Like = 1,
        Dislike = 2,
    }
    ...
    public enum WorkflowExecutionModeEnum
    {
        Sequential = 1,
        Parallel = 2,
    }
    ...
    public enum StepTaskEscalationTypeEnum
    {
        ForwardNotification = 0,
        ForwardTask = 1
    }
    ...
    public enum QRCodeDataTypeEnum
    {
        Url = 0,
        Text = 1
    }
    ...
    public enum ThemeEnum
    {
        ...
        Looper = 13,
        LooperWebsite = 14,
        LooperWebsiteSrinagar = 15,
        LooperTecProcess = 16,
        LooperJammuCustomer = 17,
        LooperJammuEmployee = 18
    }
    ...
    public enum StockAdjustmentTypeEnum : int
    {
        Add = 0,
        Deduct = 1
    }
    ...
    public enum SmsSendingTypeEnum : int
    {
        Individual = 0,
        Bulk = 1
    }
    public enum ReferenceTypeEnum : int
    {
        ...
        Page = 84,
        File = 85,
        STAFF_JOINING_FORMALITIES = 86,
        WORKER_JOINING_FORMALITIES = 87
    }
    ...
    public enum NtsEmailTargetTypeEnum : int
    {
        Service = 0,
        StepTask = 1,
        ServiceComment = 3,
    ...
    public enum EmailInboxTypeEnum : int
    {
        Drafted = 0,
        Pending = 1,
        Completed = 2
    ...
    public enum GranularityEnum : int
    {
        [Description("Day")]
        day = 0,
        [Description("Minute")]
    ...
    public enum SocialMediaDatefilters : int
    {
        ...
        LastYear = 13,
        [Description("Last 5 Mins")]
        Last5Mins = 14,
        [Description("Last 15 Mins")]
        Last15Mins = 15,
        [Description("Last 30 Mins")]
        Last30Mins = 16,
        [Description("Last 1 Hour")]
        Last1Hour = 17,
        [Description("Last 4 Hour")]
        Last4Hour = 18,
        [Description("Last 8 Hour")]
        Last8Hour = 19,
        [Description("Last 12 Hour")]
        Last12Hour = 20,
        [Description("Last 24 Hour")]
        Last24Hour = 21,
    }
    public enum CubeJsDatefilters : int
    {
        Custom = 0,
        [Description("All Time")]
        AllTime = 1,
    ...
    public enum WorkBoardOwnerTypeEnum : int
    {
        Admin = 0,
        OwnerOrRequester = 1,
        TeamMember = 2,
    ...
    public enum WorkBoardTypeEnum : int
    {
        Personal = 0,
        Team = 1
    }
    ...
    public enum ImsReceiptTypeEnum : int
    {
        PurchaseOrder = 0,
        StockTransfer = 1,
        StockAdjustment = 2,
    ...
    public enum ImsIssueTypeEnum : int
    ...
    public enum WorkflowVisibilityEnum : int

    {

        ShowToAll = 0,
        ShowAllToServiceOwner = 1,
        ShowAllToTaskAssignee = 2,
        ShowAllToServiceOwnerAndTaskAssignee = 3,
        ShowOnlyService = 4,
        ShowOnlyTask = 5,
        ShowOnlyServiceAndTask = 6
    }

    public enum InventoryDataFilterEnum : int
    {
        Today = 0,
        Yesterday = 1,
        [Description("This Week")]
    ...
    public enum BLSAppointmentStatusEnum : int
    {
        Pending = 0,
        Booked = 1,
        Completed = 2
    ...
    public enum SLATypeEnum : int
    {
        OneWeek = 1,
        TwoWeek = 2,
        ThreeWeek = 3,
    }
    public enum BillGenerationDayEnum : int
    {
        One = 1,
        Two = 2,
        Three = 3,
    ...
    public enum PropertyColumnTypeEnum
    {
        Range = 0,
        Code = 1,
    }
    public enum JSCValueTypeEnum : int
    {
        Percentage = 1,
        Flat = 2,
    }

    public enum GrievanceDatefilters : int
    {
        Custom = 0,
        [Description("All Time")]
        AllTime = 1,
