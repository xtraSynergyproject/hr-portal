...
{
    [Area("INV")]
    public class InventoryMasterDataController : ApplicationController
    {
        ...
        public InventoryMasterDataController(IServiceBusiness serviceBusinness, IUserContext userContext, ITableMetadataBusiness tableMetadataBusinness,
            ICmsBusiness cmsBusiness, INoteBusiness noteBusinness, IInventoryManagementBusiness inventoryManagementBusinness, ILOVBusiness lovBusiness) 
        {
        ...
        public async Task<IActionResult> RequisitionIssue(string serviceId)
        {
            ...
            model.IssueReferenceId = serviceId;
            ...
            {               
                    ...
                    if (result.IsSuccess)
                    {
                        if (model.Items.IsNotNullAndNotEmpty())
                        {
                           ...
                           // {
                            //if (Convert.ToDecimal(item.ItemQuantity) > Convert.ToDecimal(item.BalanceQuantity))
                            //{
