...
namespace Synergy.App.Repository
{
    public class PostgreDbContext : DbContext
    {
        ...
        public DbSet<UserRoleHierarchyPermission> UserRoleHierarchyPermission { get; set; }
        public DbSet<FormResourceLanguage> FormResourceLanguage { get; set; }
        public DbSet<NoteResourceLanguage> NoteResourceLanguage { get; set; }
        public DbSet<StepTaskAssigneeLogic> StepTaskAssigneeLogic { get; set; }
        public DbSet<StepTaskSkipLogic> StepTaskSkipLogic { get; set; }
        public DbSet<DocumentESign> DocumentESign { get; set; }
        public DbSet<NtsNoteUserReaction> NtsNoteUserReaction { get; set; }
        public DbSet<QRCodeData> QRCodeData { get; set; }
        public DbSet<UserPreference> UserPreference { get; set; }
        public DbSet<UserRolePreference> UserRolePreference { get; set; }
        public DbSet<StepTaskEscalation> StepTaskEscalation { get; set; }
        public DbSet<StepTaskEscalationData> StepTaskEscalationData { get; set; }
        public DbSet<RuntimeWorkflow> RuntimeWorkflow { get; set; }
        public DbSet<RuntimeWorkflowData> RuntimeWorkflowData { get; set; }
        public DbSet<Captcha> Captcha { get; set; }
        public DbSet<BLSAppointment> BLSAppointment { get; set; }
        public DbSet<BLSAppointmentSlot> BLSAppointmentSlot { get; set; }
        ...
        public DbSet<UserRoleHierarchyPermissionLog> UserRoleHierarchyPermissionLog { get; set; }
        public DbSet<FormResourceLanguageLog> FormResourceLanguageLog { get; set; }
        public DbSet<NoteResourceLanguageLog> NoteResourceLanguageLog { get; set; }
        public DbSet<StepTaskAssigneeLogicLog> StepTaskAssigneeLogicLog { get; set; }
        public DbSet<StepTaskSkipLogicLog> StepTaskSkipLogicLog { get; set; }

        public DbSet<DocumentESignLog> DocumentESignLog { get; set; }
        public DbSet<NtsNoteUserReactionLog> NtsNoteUserReactionLog { get; set; }
        public DbSet<QRCodeDataLog> QRCodeDataLog { get; set; }
        public DbSet<UserPreferenceLog> UserPreferenceLog { get; set; }
        public DbSet<UserRolePreferenceLog> UserRolePreferenceLog { get; set; }

        public DbSet<StepTaskEscalationLog> StepTaskEscalationLog { get; set; }
        public DbSet<StepTaskEscalationDataLog> StepTaskEscalationDataLog { get; set; }

        public DbSet<RuntimeWorkflowLog> RuntimeWorkflowLog { get; set; }
        public DbSet<RuntimeWorkflowDataLog> RuntimeWorkflowDataLog { get; set; }
        public DbSet<CaptchaLog> CaptchaLog { get; set; }
        public DbSet<BLSAppointmentLog> BLSAppointmentLog { get; set; }
        public DbSet<BLSAppointmentSlotLog> BLSAppointmentSlotLog { get; set; }
        ...
        private void DisableDatabaseInheritence(ModelBuilder builder)
        {
            ...
            builder.Entity<UserRoleHierarchyPermissionLog>().HasBaseType((Type)null);
            builder.Entity<FormResourceLanguageLog>().HasBaseType((Type)null);
            builder.Entity<NoteResourceLanguageLog>().HasBaseType((Type)null);
            builder.Entity<StepTaskAssigneeLogicLog>().HasBaseType((Type)null);
            builder.Entity<StepTaskSkipLogicLog>().HasBaseType((Type)null);
            builder.Entity<DocumentESignLog>().HasBaseType((Type)null);
            builder.Entity<NtsNoteUserReactionLog>().HasBaseType((Type)null);
            builder.Entity<QRCodeDataLog>().HasBaseType((Type)null);
            builder.Entity<UserPreferenceLog>().HasBaseType((Type)null);
            builder.Entity<UserRolePreferenceLog>().HasBaseType((Type)null);
            builder.Entity<StepTaskEscalationLog>().HasBaseType((Type)null);
            builder.Entity<StepTaskEscalationDataLog>().HasBaseType((Type)null);
            builder.Entity<RuntimeWorkflowLog>().HasBaseType((Type)null);
            builder.Entity<RuntimeWorkflowDataLog>().HasBaseType((Type)null);
            builder.Entity<CaptchaLog>().HasBaseType((Type)null);
            builder.Entity<BLSAppointmentLog>().HasBaseType((Type)null);
            builder.Entity<BLSAppointmentSlotLog>().HasBaseType((Type)null);
