...
{
    public class RepositoryPostgresBaseMigration<V, D> : IRepositoryBase<V, D> where V : DataModelBase where D : DataModelBase
    {
        ...
        public RepositoryPostgresBaseMigration(DbContextOptions<PostgreDbContext> dbOptions,
        ...
        {
            if (!model.CreatedDate.IsNotNull())
            {
                model.CreatedDate = DateTime.Now;
            }
            if (!model.LastUpdatedDate.IsNotNull())
            {
