...
//else
var server = "https://10.100.100.101/janus";
var streamId = null;
							...
							janus.attach(
								{
									...
									onremotetrack: function (track, mid, on) {
										...
										if (track.kind === "audio") {
											...
											$('#' + mstreamId).append('<video class="rounded centered hide" id="remotevideo' + mid + '" width="100%" height="100%" controls playsinline/>');
											$('#remotevideo' + mid).get(0).volume = 0;
...
function startRtspStream() {
	...
	Janus.log(streamId1);
	Janus.log("---- Starting RTSP Stream: " + rtsp + " with ID: " + streamId1);
	streaming.send(
		{
			"message": {
				"request": "create",
				"type": "rtsp",
				"id": streamId1,
				"description": "RTSP Test 1" + streamId1,
				"video": true,
				"audio": false,
				"url": "rtsp://10.0.12.253/cam/realmonitor?channel=1&subtype=0",
				"rtsp_user" = "admin",
				"rtsp_pwd" : "1234",
				"videoport" : 8004,
				"videopt" : 126,
