...
FarsiType.init = function () {
    ...
    for (var i = 0; i < Inputs.length; i++) {
        if (Inputs[i].type.toLowerCase() == 'text' && (Inputs[i].lang.toLowerCase() == 'hi' || Inputs[i].lang.toLowerCase() == 'hi-in')) {
            FarsiType.counter++;
    ...
    for (var i = 0; i < Areas.length; i++) {
        if (Areas[i].lang.toLowerCase() == 'hi' || Areas[i].lang.toLowerCase() == 'hi-in') {
            FarsiType.counter++;
