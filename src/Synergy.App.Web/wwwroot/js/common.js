...
window.OnServiceImageError = (obj) => {
    obj.onerror = null;
    obj.src = '/images/nts/ServiceImage.png';

};
window.OnAssetImageError = (obj) => {
    obj.onerror = null;
    obj.src = '/images/EGOV/Jammu/Building.png';

};
window.OnTaskImageError = (obj) => {
    obj.onerror = null;
    obj.src = '/images/nts/TaskImage.png';

};
window.OnNoteImageError = (obj) => {
    obj.onerror = null;
    obj.src = '/images/nts/NoteImage.png';
...
function GetIframeOrWindow(iframeName) {
    var iframe_object = document.getElementById(iframeName);
