...
function OpenContextMenu(e, y, x) {
    ...
    if (type == "null") {
        ...
        menu.find("#editgroup").hide();

        menu.find("#createbook").hide();
        menu.find("#edit").hide();
        menu.find("#deleteCategory").hide();
        menu.find("#editpage").hide();
        menu.find("#view").hide();
        menu.find("#deletepage").hide();
    }
    else if (type == "Category") {
        //return {
        if (permissions != null && permissions.includes("CanManageBook") || isAdmin) {
            menu.find("#createbook").show();
        } else {
            menu.find("#createbook").hide();
        }

        if (permissions != null && permissions.includes("CanManageCategory") || isAdmin) {
            menu.find("#edit").show();
            menu.find("#share").show();
            menu.find("#deleteCategory").show();
        } else {
            menu.find("#edit").hide();
            menu.find("#share").hide();
            menu.find("#deleteCategory").hide();
        ...
        if (permissions != null && permissions.includes("CanManageBook") || isAdmin) {
            menu.find("#page").show();
            menu.find("#existingpage").show();
            menu.find("#createbookbelow").show();
            menu.find("#share").show();
        ...
        menu.find("#editpage").show();
        menu.find("#view").show();
        menu.find("#deletepage").show();

        menu.find("#createbook").hide();
        menu.find("#edit").hide();
        menu.find("#share").hide();onAfterCategoryCreate
        menu.find("#deleteCategory").hide();
        menu.find("#editgroup").hide();
