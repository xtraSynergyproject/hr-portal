...
{
    public class SuccessionPlaningViewModel
    {
        ...
        public string Sa5 { get; set; }
        public string Sa6 { get; set; }
        public string Sa7 { get; set; }
        public string Sa8 { get; set; }
        public string Sa9 { get; set; }
        ...
        public string Sa26 { get; set; }
        public string Sa27 { get; set; }
        public string Sa28 { get; set; }
        public string Sa29 { get; set; }
        public string Sa30 { get; set; }
        public string Sa31 { get; set; }
