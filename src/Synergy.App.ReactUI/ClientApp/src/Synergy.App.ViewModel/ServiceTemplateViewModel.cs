...
namespace Synergy.App.ViewModel
{
    public class ServiceTemplateViewModel : ServiceTemplate
    {
        ...
        public bool IsReturnReasonVisible
        {
            get
            {
                return (ServiceStatusCode == "SERVICE_STATUS_DRAFT") && (ReturnReason.IsNotNullAndNotEmpty())
                    && (ActiveUserType == NtsActiveUserTypeEnum.Owner || ActiveUserType == NtsActiveUserTypeEnum.Requester);
            }
        }
        ...
        public List<NtsEmailViewModel> EmailList { get; set; }
        ...
        public List<ComponentResultViewModel> ComponentResultList { get; set; }
        ...
        public string ServicePlusRecordId { get; set; }
        public string ServicePlusRecordCode { get; set; }
        ...
        public NtsTypeEnum LoadType { get; set; }
        public string ContentView { get; set; }
        public string InitialItemId { get; set; }
        public TaskTemplateViewModel TaskTemplate { get; set; }

        public ProcessDesignComponentTypeEnum InitialItemType { get; set; }
