...
{
    public class PayrollSalaryElementViewModel : DataModelBase
    {
        ...
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = ApplicationConstant.DateAndTime.DefaultDateTimeFormat)]
