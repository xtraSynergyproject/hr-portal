...
function createData(TemplateCode,Position,ParentPosition,Remark,CreatedDate,CreatedByUser_Name,LastUpdatedDate,UpdatedByUser_Name){
  return createData(TemplateCode,Position,ParentPosition,Remark,CreatedDate,CreatedByUser_Name,LastUpdatedDate,UpdatedByUser_Name)
}
...
const UserList = ({ apiData }) => {
 ...
 const [addUserOpen, setAddUserOpen] = useState(false)
  ...
  const viewData=async()=>{
    let response = await axios.get(`https://webapidev.aitalkx.com/CHR/query/LoadNoteIndexPageGrid?indexPageTemplateId=f35fa3e5-b4b5-4afd-8080-fca5a06107cd&userId=45bba746-3309-49b7-9c03-b5793369d73c`)
