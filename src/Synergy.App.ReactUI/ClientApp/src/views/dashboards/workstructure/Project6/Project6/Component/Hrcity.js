...
function createData(CityName,Code,CountryId,CreatedByUser_Name,CreatedDate,LastUpdatedDate){
  return createData(CityName,Code,CountryId,CreatedByUser_Name,CreatedDate,LastUpdatedDate)
}
...
const UserList = ({ apiData }) => {
 ...
 const [addUserOpen, setAddUserOpen] = useState(false)
  ...
  const viewData=async()=>{
    let response = await axios.get(`https://webapidev.aitalkx.com/CHR/query/LoadNoteIndexPageGrid?indexPageTemplateId=d17c0d22-7c11-4778-9acf-ecdad544bcc1&userId=45bba746-3309-49b7-9c03-b5793369d73c`)
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title={<h3> HR City</h3>} />
          <CardContent>
            <Grid container spacing={6}>
