...
function createData(){PersonFullName,IqamahNoNationalId,Biometric,CreatedBy,CreatedDate,LastUpdatedDate
  return createData(PersonFullName,IqamahNoNationalId,Biometric,CreatedBy,CreatedDate,LastUpdatedDate)
}
...
const UserList = ({ apiData }) => {
 ...
 const [addUserOpen, setAddUserOpen] = useState(false)
  ...
  const viewData=async()=>{
    let response = await axios.get(`https://webapidev.aitalkx.com/CHR/query/LoadNoteIndexPageGrid?indexPageTemplateId=efc068a9-3924-425d-a96a-0c8024ca8180&userId=45bba7`)
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title={<h3>Department Hierarchy</h3>} />
          <CardContent>
            <Grid container spacing={6}>
