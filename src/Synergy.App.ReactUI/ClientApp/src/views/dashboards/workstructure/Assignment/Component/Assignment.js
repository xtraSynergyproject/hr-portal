...
function createData(){AssignmentTypeId,CreatedByUser_Name
  return createData(AssignmentTypeId,CreatedByUser_Name)
}
...
const UserList = ({ apiData }) => {
 ...
 const [addUserOpen, setAddUserOpen] = useState(false)
  ...
  const viewData=async()=>{
    let response = await axios.get(`https://webapidev.aitalkx.com/CHR/query/LoadNoteIndexPageGrid?indexPageTemplateId=cdd4d6ab-3aad-4c31-80f2-0f9081288753&userId=45bba746-3309-49b7-9c03-b5793369d73c`)
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title={<h3>Assignment</h3>} />
          <CardContent>
            <Grid container spacing={6}>
