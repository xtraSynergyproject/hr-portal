...
function createData(BankAccountNumber,FlightTicketFrequency,PaymentMode,UnpaidLeavesNotInSystem,OvertimePaymentType,BankBranchIdBranchCode,BankIBanNumber){
  return(BankAccountNumber,FlightTicketFrequency,PaymentMode,UnpaidLeavesNotInSystem,OvertimePaymentType,BankBranchIdBranchCode,BankIBanNumber)
}
