...
namespace CMS.UI.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null, string theme = null)
        {
            ...
            ReturnUrl = returnUrl;
            ViewData["Layout"] = "~/Areas/Core/Views/Shared/_LoginLayout.cshtml";
            if (theme.IsNotNullAndNotEmpty())
            {
                ViewData["Layout"] = $"~/Areas/Core/Views/Shared/Themes/{theme}/_LoginLayout.cshtml";
            }
        }
