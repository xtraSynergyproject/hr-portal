...
namespace CMS.UI.Web.Areas.Pay.Controllers
{
    ...
    public class SalaryInfoController : ApplicationController
    {
        ...
        public async Task<IActionResult> CreateSalaryElement(string id,string salaryInfoId)
        
        {
            ...
            {
                var SalaryInfo = await _payrollBatchBusiness.GetSalaryElementInfoDetails(id,salaryInfoId);
                if (SalaryInfo != null)
                {
