...
(function() {
    ...
    var options = {
        ...
        colorPalette: [
            { content: 'transparent', icon: 'https://localhost:44389/lib/joint.js/config/transparent-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        colorPaletteReset: [
            { content: undefined, icon: 'https://localhost:44389/lib/joint.js/config/no-color-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        imageIcons: [
            { value: 'https://localhost:44389/lib/joint.js/config/image-icon1.svg', content: '<img height="42px" src="https://localhost:44389/lib/joint.js/config/image-icon1.svg"/>' },
            { value: 'https://localhost:44389/lib/joint.js/config/image-icon2.svg', content: '<img height="80px" src="https://localhost:44389/lib/joint.js/config/image-icon2.svg"/>' },
            { value: 'https://localhost:44389/lib/joint.js/config/image-icon3.svg', content: '<img height="80px" src="https://localhost:44389/lib/joint.js/config/image-icon3.svg"/>' },
            { value: 'https://localhost:44389/lib/joint.js/config/image-icon4.svg', content: '<img height="80px" src="https://localhost:44389/lib/joint.js/config/image-icon4.svg"/>' }
        ],

        imageGender: [
            { value: 'https://localhost:44389/lib/joint.js/config/member-male.png', content: '<img height="50px" src="https://localhost:44389/lib/joint.js/config/member-male.png" style="margin: 5px 0 0 2px;"/>' },
            { value: 'https://localhost:44389/lib/joint.js/config/member-female.png', content: '<img height="50px" src="https://localhost:44389/lib/joint.js/config/member-female.png" style="margin: 5px 0 0 2px;"/>' }
        ],
