...
namespace Synergy.App.Business
{
    public interface IProjectManagementBusiness : IBusinessBase<ServiceViewModel, NtsService>
    {
        ...
        Task<IList<ProjectGanttTaskViewModel>> ReadProjectUserWorkloadGridViewData(string userIds, string projectIds = null, string ownerIds = null, string assigneeIds = null, string tasksStatus = null, FilterColumnEnum? column = null, DateTime? startDate = null, DateTime? dueDate = null);
