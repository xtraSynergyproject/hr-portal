...
namespace Synergy.App.Business
{
    public interface IServiceBusiness : IBusinessBase<ServiceViewModel, NtsService>
    {
        ...
        Task<IList<NtsServiceIndexPageViewModel>> GetServiceCountByServiceTemplateCodes(string categoryCodes, string portalId, bool isIncluded = false);
        Task<IList<ServiceViewModel>> GetServiceListByServiceCategoryCodes(string categoryCodes, string status, string portalId);
        Task<NtsSummaryViewModel> GetServiceSummary(string portalId, string userId);
        Task<List<IdNameViewModel>> GetSEBIInvestorListedCompanyIdNameList(string entityType);
        ...
        Task<IList<NtsServiceIndexPageViewModel>> GetServiceListCountWithDepartment(string categoryCodes = null, string templateCodes = null, string moduleCodes = null, string portalNames = null, string departmentId = null, string templateId = null, string userId = null);
