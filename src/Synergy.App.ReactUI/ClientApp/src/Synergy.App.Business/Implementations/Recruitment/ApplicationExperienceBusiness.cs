...
namespace Synergy.App.Business
{
    public class ApplicationExperienceBusiness : BusinessBase<ApplicationExperienceViewModel, ApplicationExperience>, IApplicationExperienceBusiness
    {
        ...
        public async override Task<CommandResult<ApplicationExperienceViewModel>> Create(ApplicationExperienceViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<ApplicationExperienceViewModel>> Edit(ApplicationExperienceViewModel model, bool autoCommit = true)
        {
            var data = _autoMapper.Map<ApplicationExperienceViewModel>(model);
            //var validateName = await IsNameExists(data);
            //if (!validateName.IsSuccess)
