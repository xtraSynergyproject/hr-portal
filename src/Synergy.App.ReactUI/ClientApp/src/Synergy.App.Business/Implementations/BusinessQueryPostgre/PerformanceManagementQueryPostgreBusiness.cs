...
{
    public class PerformanceManagementQueryPostgreBusiness : BusinessBase<ServiceViewModel, NtsService>, IPerformanceManagementQueryBusiness
    {
        ...
        public PerformanceManagementQueryPostgreBusiness(IRepositoryBase<ServiceViewModel, NtsService> repo, IRepositoryQueryBase<ServiceViewModel> queryRepo,
        ...
        public async Task<IList<ProgramDashboardViewModel>> GetPerformanceData(string userId)
        {
            ...
            string query = @$"select distinct s.""Id"" as Id,
                pdudf.""Name"" as Name,pdudf.""Year"" as Year,
                --pdms.""Name"" as MasterStageName,pdms.""Id"" as MasterStageId,
                pdudf.""Name"" as ProjectName,pdudf.""StartDate"" as StartDate,
				pdudf.""EndDate"" as DueDate,s.""CreatedDate"" as CreatedOn,pdudf.""DocumentStatus"" as PerformanceDocumentStatus,
        ...
        public async Task<IList<StageViewModel>> GetPerformanceStageData(string userId, string performanceDocumentId)
        {
            ...
            string query = $@"select distinct s.""ServiceSubject"" as StageName, s.""Id"" as StageId, s.""ParentServiceId"" as PerformanceDocumentId,s.""UdfNoteTableId"" as DocumentStageId,
                            lov.""Name"" as Status, s.""StartDate"" as StartDate, s.""DueDate"" as EndDate,pds.""DocumentMasterStageId""
                            from public.""NtsService"" as s 
                            left join public.""LOV"" as lov on lov.""Id"" =  s.""ServiceStatusId""
                            join cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds on s.""UdfNoteTableId""=pds.""Id"" and pds.""IsDeleted""=false
...
";
        ...
        public async Task<IList<ProgramDashboardViewModel>> GetPerformanceSharedData()
        {
            ...
            string query = @$"select distinct s.""Id"" as Id,ucount.""Count"" as UserCount,
                ...
                pdudf.""Name"" as ProjectName,pdudf.""StartDate"" as StartDate,
				pdudf.""EndDate"" as DueDate,s.""CreatedDate"" as CreatedOn,
s.""LastUpdatedDate"" as UpdatedOn,u.""Name"" as CreatedBy,pdudf.""DocumentStatus"" as PerformanceDocumentStatus,
...
--  GROUP BY s.""Id"", s.""ServiceSubject"", t.""Count""  ";
        ...
        public async Task<long?> GetInboxMenuItemData(string roleText, string userId)
        {
            var query = "";
            query = $@"  
                WITH RECURSIVE Nts AS(
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemIndex(string roleText, string userId)
        {
            var query = "";
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemUserRole(string id, string userRoleId, string userId)
        {
            var query = "";
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemProjectStage(string id, string userRoleId, string userId)
        {
            var query = "";
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemProject(string id, string userId)
        {
            var query = "";
        ...
        public async Task<long?> GetInboxMenuItemByUserData(string roleText, string userId)
        ...
        public async Task<long?> GetInboxMenuItemGeneral(string userId)
        {
            var rquery = @$"
        ...
        public async Task<long?> GetInboxMenuItemGeneralCount(string userId)
        {
            var squery = @$"
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralInbox(string roleText, string userId)
        {
            var query = "";
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralUserRole(string id, string userRoleId, string userId)
        {
            var query = "";
...
and usp.""IsDeleted""=false and usp.""CompanyId""='{_userContext.CompanyId}' and usp.""ChildSequence""='1'
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralPerformance(string id, string userRoleId, string userId, string stageId)
        {
            var query = "";
            query = $@"select  s.""Id"" as id,
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralStageType(string id, string userRoleId, string userId, string performanceId)
        {
            var query = "";
            query = $@"Select usp.""InboxStageName"" ||' (' || COALESCE(nt.""Count"",0)|| ')' as Name
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralStage(string id, string userId, string stageId, string performanceId)
        {
            var query = "";
            query = $@"select  s.""Id"" as id,
                s.""ServiceSubject"" ||' (' || COALESCE(t.""Count"",0) || ')' as Name,
        ...
        public async Task<List<TreeViewViewModel>> GetInboxMenuItemGeneralStatus(string id, string stageId)
        {
            var query = "";
...
where s.""OwnerUserId""='{userId}' and s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' 
                 ...
                 SELECT ""Code"",""TemplateId"",""Id"",""ServiceSubject"" as Title,""StartDate"" as Start,""DueDate"" as End,""ParentId"",""UserName"",""OwnerName"",""UserId"",""ProjectName"",""ServiceStage"",""Priority"",""NtsStatus"",'Parent' as Level,""TemplateCode"" from NtsService where ""StageId""='{stageId}' or '{stageId}'=''
...
FROM public.""NtsService"" as s
                        join NtsService ns on s.""ParentServiceId""=ns.""ServiceId""
                           left join (select g.*,pdn.""Id"" as ""StageId"" from cms.""N_PerformanceDocument_PMSGoal"" as g
									  ...
									  join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pdn.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
									  join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  and pdm.""IsDeleted""=false
									  where   g.""IsDeleted""=false and g.""CompanyId""='{_userContext.CompanyId}' 
...
where s.""OwnerUserId""='{userId}' and s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' 
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> ReadPerformanceTaskUserGridViewData(string userId, List<string> projectIds = null, List<string> ownerIds = null, List<string> assigneeIds = null, List<string> tasksStatus = null, FilterColumnEnum? column = null, DateTime? startDate = null, DateTime? dueDate = null, List<string> pmsTypes = null, List<string> stageIds = null)
        {
            ...
            var query = @$"
                 ...
                 WITH RECURSIVE NtsService AS(
                 SELECT s.*, s.""Id"" as ""ServiceId"", s.""ParentServiceId"" as ""ParentId"",u.""Name"" as ""UserName"",u.""Name"" as ""OwnerName"", sp.""Name"" as ""Priority"", ss.""Name"" as ""NtsStatus""
                       ,pd.""Name"" as ""ProjectName"",s.""ParentServiceId"" as ""ServiceStage"",tt.""Code"" as ""Type"",tt.""Code"" as ""TypeCode"" FROM public.""NtsService"" as s
...
join public.""Template"" as tt on tt.""Id"" =s.""TemplateId"" and  tt.""IsDeleted""=false and tt.""CompanyId""='{_userContext.CompanyId}' 
                ...
                when tt1.""Code"" = 'PMS_DEVELOPMENT' then d.""DevelopmentName"" when tt1.""Code"" = 'PMS_PEER_REVIEW' then s.""ServiceSubject"" END as ""ServiceStage"",tt1.""Code"" as ""Type"",tt1.""Code"" as ""TypeCode"" 
FROM public.""NtsService"" as s
                        join NtsService ns on s.""ParentServiceId""=ns.""ServiceId""
...
where 1=1  #PmsTypeWhere#  
                ...
                when ""Type""='PMS_DEVELOPMENT' then 'Development' when ""Type""='PMS_PEER_REVIEW' then 'PeerReview' END as ""Type"",""TypeCode""
                from NtsService
            ...
            //                  ";
            var projectSerach = @$" tt.""Code""='PMS_PERFORMANCE_DOCUMENT' ";
            if (projectIds.IsNotNull() && projectIds.Count > 0)
            {
                string pids = null;
                foreach (var i in projectIds)
                {
                    if (i.IsNotNullAndNotEmpty())
                    {
                        pids += $"'{i}',";
                    }
                }
...
join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pd.""NtsNoteId""=ns.""UdfNoteId"" and  pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}'
        ...
        public async Task<List<ProjectGanttTaskViewModel>> GetPerformanceDashboardDetailsData(string projectId, string stageId = null)
        {
            var query1 = @$"
                           WITH RECURSIVE Nts AS(
        ...
        public async Task<List<ProjectGanttTaskViewModel>> GetTaskStatus(string userId, string projectId, string stageId = null)
        {
...
where 1=1 #OWNERSEARCH#  and s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' 
        ...
        public async Task<List<ProjectGanttTaskViewModel>> GetPerformanceServicesStatus(string userId, string projectId, string type, string stageId = null)
        {
...
FROM public.""NtsService"" as s
 ...
 where 1=1 #OWNERSEARCH#
        ...
        public async Task<List<ProjectGanttTaskViewModel>> GetPerformanceServiceStatus(string userId, string projectId, string type, string stageId = null)
        {
            var query = "";
            if (type == "PMS_GOAL")
            {
            ...
            ";
                if (stageId.IsNullOrEmpty())
                {
                    query = @$" SELECT gns.""TemplateCode"" as TemplateCode,gns.""Id"",g.""GoalName"" as Title,g.""GoalStartDate"" as Start,g.""GoalEndDate"" as End,gns.""ParentServiceId"" as ParentId,u.""Name"" as ""UserName"",Pdm.""Name"" as ProjectName,sp.""Name"" as ""Priority"",ss.""Name"" as ""NtsStatus"",ss.""Id"" as ""NtsStatusId"",'Parent' as Level
            from  cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm 
            
            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId""  and pd.""IsDeleted""=false             
            join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
            join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_GOAL' and gns.""OwnerUserId""=pdns.""OwnerUserId""  and gns.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSGoal"" as g on gns.""UdfNoteId""=g.""NtsNoteId"" 
            left join public.""LOV"" as sp on sp.""Id"" = gns.""ServicePriorityId"" and sp.""IsDeleted""=false 
            left join public.""LOV"" as ss on ss.""Id"" = gns.""ServiceStatusId"" and ss.""IsDeleted""=false 
            left join public.""User"" as u on u.""Id"" = gns.""OwnerUserId"" and u.""IsDeleted""=false 
             left join public.""User"" as r on r.""Id"" = gns.""RequestedByUserId"" and r.""IsDeleted""=false  
            where pdm.""IsDeleted""=false and pdns.""Id""='{projectId}' and pdns.""OwnerUserId""='{userId}'
            ";
                }
            }
...
";
                if (stageId.IsNullOrEmpty())
                {
                    query = @$" SELECT gns.""TemplateCode"" as TemplateCode,gns.""Id"",g.""CompetencyName"" as Title,g.""CompetencyStartDate"" as Start,g.""CompetencyEndDate"" as End,gns.""ParentServiceId"" as ParentId,u.""Name"" as ""UserName"",Pdm.""Name"" as ProjectName,sp.""Name"" as ""Priority"",ss.""Name"" as ""NtsStatus"",ss.""Id"" as ""NtsStatusId"",'Parent' as Level
            from cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm
            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId""  and pd.""IsDeleted""=false
            join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
            join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_COMPENTENCY' and gns.""OwnerUserId""=pdns.""OwnerUserId""  and gns.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSCompentency"" as g on gns.""UdfNoteId""=g.""NtsNoteId"" 
            left join public.""LOV"" as sp on sp.""Id"" = gns.""ServicePriorityId"" and sp.""IsDeleted""=false 
            left join public.""LOV"" as ss on ss.""Id"" = gns.""ServiceStatusId"" and ss.""IsDeleted""=false 
            left join public.""User"" as u on u.""Id"" = gns.""OwnerUserId"" and u.""IsDeleted""=false 
             left join public.""User"" as r on r.""Id"" = gns.""RequestedByUserId"" and r.""IsDeleted""=false  
...
";
                ...
                if (stageId.IsNullOrEmpty())
                {
                    query = @$" SELECT gns.""TemplateCode"" as TemplateCode,gns.""Id"",g.""DevelopmentName"" as Title,g.""DevelopmentStartDate"" as Start,g.""DevelopmentEndDate"" as End,gns.""ParentServiceId"" as ParentId,u.""Name"" as ""UserName"",Pdm.""Name"" as ProjectName,sp.""Name"" as ""Priority"",ss.""Name"" as ""NtsStatus"",ss.""Id"" as ""NtsStatusId"",'Parent' as Level
            from  cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm 
            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId""  and pd.""IsDeleted""=false
            join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
            join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_DEVELOPMENT' and gns.""OwnerUserId""=pdns.""OwnerUserId""  and gns.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSDevelopment"" as g on gns.""UdfNoteId""=g.""NtsNoteId""            
            left join public.""LOV"" as sp on sp.""Id"" = gns.""ServicePriorityId"" and sp.""IsDeleted""=false 
            left join public.""LOV"" as ss on ss.""Id"" = gns.""ServiceStatusId"" and ss.""IsDeleted""=false 
            left join public.""User"" as u on u.""Id"" = gns.""OwnerUserId"" and u.""IsDeleted""=false 
             left join public.""User"" as r on r.""Id"" = gns.""RequestedByUserId"" and r.""IsDeleted""=false  
...
and NTS.""TaskStatusId""='370d3df9-5e97-4127-81e1-d7dd8fe8836a' and  NTS.""IsDeleted""=false and NTS.""CompanyId""='{_userContext.CompanyId}'
 Group by NTS.""DueDate""::TIMESTAMP::DATE ";
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> GetTaskType(string userId, string performanceId, string stageId = null)
        {
...
where 1=1 #OWNERSEARCH#  and s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' 
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> ReadPerformanceStageChartData(string userId, string projectId)
        {
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> GetPerformanceStageIdNameList(string userId, string projectId)
        {
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> GetPerformanceObjectiveList(string userId, string projectId)
        {
            //var search = @$" tt.""Code""='PMS_PERFORMANCE_DOCUMENT' and s.""OwnerUserId""='{userId}'";
            var search = "";
            var Ownersearch = "";
        ...
        public async Task<IList<ProjectGanttTaskViewModel>> GetPerformanceStageIdNameList(string userId, string projectId, List<string> ownerIds = null, List<string> types = null)
        {
            var search = @$" tt.""Code""='PMS_PERFORMANCE_DOCUMENT' and s.""OwnerUserId""='{userId}'";
...
left join cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as udf on udf.""NtsNoteId"" = s.""UdfNoteId"" and  udf.""IsDeleted""=false and udf.""CompanyId""='{_userContext.CompanyId}'
 left join public.""User"" as r on r.""Id"" = s.""RequestedByUserId""  and  r.""IsDeleted""=false and r.""CompanyId""='{_userContext.CompanyId}'      
        ...
        {
            var query = @$"
               select distinct pms.""Id"" as StageId ,pds.""Name"" as StageName,ps.""Id"",r.""Name"" as OwnerDisplayName,pds.""StartDate"",pds.""EndDate""
from public.""NtsService"" as s
...
and s.""CompanyId""='{_userContext.CompanyId}' and s.""Id""='{performanceServiceId}' #STAGE# order by pds.""StartDate"" desc ";
        ...
        {
            var query = @$"select pdms.""Id"" as StageId, pdms.""Name"" as StageName 
from cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm
join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdm.""Id""=pdms.""DocumentMasterId"" and pdms.""IsDeleted""=false and pdms.""CompanyId""='{_userContext.CompanyId}' 
where pdm.""NtsNoteId""='{performanceServiceId}' and pdm.""CompanyId""='{_userContext.CompanyId}' and pdm.""IsDeleted""=false #STAGE# order by pdms.""StartDate"" desc ";

            var stageFilter = "";
            if (stageId.IsNotNullAndNotEmpty())
            {
                stageFilter = $@" and pdms.""Id""='{stageId}'";
            }
            query = query.Replace("#STAGE#", stageFilter);
            var queryData = await _queryTWRepo.ExecuteQueryList<ServiceViewModel>(query, null);
            return queryData;
...
and  s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' and ss.""Code""='SERVICE_STATUS_COMPLETE'";
        ...
        public async Task<IList<TeamWorkloadViewModel>> ReadManagerPerformanceGoalViewData(string performanceId, string stageId, string userId)
        {
            ...
            ,r.""Id"" as RequestedByUserId,r.""Name"" as RequestedByUserName,gns.""CompletedDate"",gns.""ServiceDescription"",
            g.""Weightage"" as Weightage,g.""SuccessCriteria"" as SuccessCriteria,g.""ManagerComments"" as ManagerComments
            ,g.""EmployeeRating"",g.""EmployeeComments"" as EmployeeComment,g.""ManagerRating"" as ManagerRating,gns.""UdfNoteTableId"" as UdfNoteTableId
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  and pdm.""IsDeleted""=false
...
select gns.""Id"" as Id,u.""Id"" as ProjectOwnerId,u.""Name"" as ProjectOwnerName,g.""CompetencyName"" as StageName,gns.""TemplateCode"" as TemplateCode
            ...
            ,g.""CompetencyStartDate"" as ""StartDate"",g.""CompetencyEndDate""as DueDate,gns.""ParentServiceId""
            ,r.""Id"" as RequestedByUserId,r.""Name"" as RequestedByUserName,gns.""CompletedDate"",gns.""ServiceDescription"",
            g.""Weightage"" as Weightage,g.""SuccessCriteria"" as SuccessCriteria,g.""ManagerComment"" as ManagerComments,gns.""UdfNoteTableId"" as UdfNoteTableId
            ,g.""EmployeeRating"",g.""EmployeeComment"" as EmployeeComment,g.""ManagerRating"" as ManagerRating
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
...
select gns.""Id"" as Id,u.""Id"" as ProjectOwnerId,u.""Name"" as ProjectOwnerName,g.""DevelopmentName"" as StageName,gns.""TemplateCode"" as TemplateCode
            ...
            ,r.""Id"" as RequestedByUserId,r.""Name"" as RequestedByUserName,gns.""CompletedDate"",gns.""ServiceDescription"",gns.""UdfNoteTableId"" as UdfNoteTableId
...
";
        ...
        public async Task<IList<DashboardCalendarViewModel>> ReadPerformanceCalendarViewData(string projectId, List<string> assigneeIds = null, List<string> statusIds = null, List<string> ownerIds = null, FilterColumnEnum? column = null, DateTime? startDate = null, DateTime? dueDate = null, string performanceStageId = null)
        {
            var query = @$"
                 ...
                 select t.""Id"",null as ServiceId,temp.""Code"" as TemplateCode,t.""TaskSubject"" as ""Title"", t.""StartDate""::TIMESTAMP::DATE as Start, t.""DueDate""::TIMESTAMP::DATE as End, u.""Name"" as UserName,t.""AssignedToUserId"" as AssigneeUserId,t.""OwnerUserId"" as OwnerUserId,ss.""Name"" as StatusName,t.""TaskStatusId"" as TaskStatusId,'Child' as Level 
                     FROM  public.""NtsTask"" as t
                        join public.""Template"" as temp on t.""TemplateId""=temp.""Id""  and  temp.""IsDeleted""=false 
...
pd.""FinalRatingRounded"" as FinalRatingRounded,pd.""Id"" as DocId
from public.""NtsService"" as s
  join public.""LOV"" as ss on ss.""Id"" = s.""ServiceStatusId"" and  ss.""IsDeleted""=false and ss.""CompanyId""='{_userContext.CompanyId}'
...
";
        ...
        public async Task<IList<IdNameViewModel>> GetPerformanceList(string userId, bool isProjectManager, string year = null)
        {
            ...
            query = @$"select s.""ServiceSubject"" as Name, s.""Id"" as Id from public.""NtsService"" as s
                            ...
                            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}' 
                            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pd.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_userContext.CompanyId}'
                            where s.""OwnerUserId""='{userId}' and  s.""IsDeleted""=false #WHERE# and s.""CompanyId""='{_userContext.CompanyId}' order by pd.""StartDate"" desc ";
        ...
        public async Task<IList<IdNameViewModel>> GetPDMList(string year = null)
        {
            ...
            var query = @$"select pdm.""Name"", pdm.""NtsNoteId"" as Id 
                            from cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm
                            ...
                            where pdm.""IsDeleted""=false #WHERE# and pdm.""CompanyId""='{_userContext.CompanyId}' order by pdm.""StartDate"" desc ";
        ...
        public async Task<ServiceViewModel> GetPDMDetails(string pdmId)
        {
            var query = $@"Select pdm.""StartDate"",pdm.""EndDate"" as DueDate,pdm.""NtsNoteId"" as UdfNoteId,pdm.""DocumentStatus"" as PerformanceDocumentStatus 
                            from cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm
                            where pdm.""NtsNoteId""='{pdmId}' and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_userContext.CompanyId}' ";
        ...
        public async Task<List<TreeViewViewModel>> GetWBSItemInboxData(string roleText, string userId)
        {
            var query = "";
            query = $@"Select distinct ur.""Id"" as id,ur.""Name"" ||' (' || nt.""Count""|| ')' as Name
                , 'INBOX' as ParentId, 'USERROLE' as Type,
        ...
        public async Task<List<TreeViewViewModel>> GetWBSItemInboxUserRole(string userId, TreeViewViewModel l)
        {
            var query = "";
            query = $@"Select usp.""InboxStageName"" ||' (' || nt.""Count""|| ')' as Name
        ...
        public async Task<List<TreeViewViewModel>> GetWBSItemInboxProjectStage(string userId, TreeViewViewModel p)
        {
            var query = "";
            query = $@"Select  usp.""TemplateShortName"" ||' (' || COALESCE(t.""Count"",0)|| ')'  as Name,
        ...
        public async Task<List<TreeViewViewModel>> GetWBSItemInboxProject(string userId, TreeViewViewModel pr)
        {
            var query = "";
            query = $@"select  s.""Id"" as id,
                s.""ServiceSubject"" ||' (' || t.""Count"" || ')' as Name,
        ...
        public async Task<List<TreeViewViewModel>> GetWBSItemInboxStage(string userId, TreeViewViewModel ps)
        {
            var query = "";
...
and ts.""Code""='TASK_STATUS_COMPLETE'  and  GRT.""NtsGroupId""='{templateId}' and t.""AssignedToUserId""='{userId}'
 ...
 ""IsDeleted""=false and ""CompanyId""='{_userContext.CompanyId}' ";
        ...
        {
            var query = $@"update cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" set ""DocumentStatus""='{(int)status}',
            ""LastUpdatedBy""='{_userContext.UserId}',""LastUpdatedDate""='{DateTime.Now.ToDatabaseDateFormat()}'
            where ""Id""='{id}'";
        ...
        {
            var query = $@"update cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" set ""DocumentStageStatus""='{(int)status}',
            ""LastUpdatedBy""='{_userContext.UserId}',""LastUpdatedDate""='{DateTime.Now.ToDatabaseDateFormat()}'
            where ""Id""='{id}'";
            var result = await _queryPerDoc.ExecuteScalar<bool?>(query, null);
            return true;
        ...
        public async Task<IList<PerformanceDocumentStageViewModel>> GetPerformanceDocumentStageData(string parentNoteId, string noteId, string udfNoteId, bool isEnableReview = false)
        {
            ...
            var query = $@"SELECT ds.*, N.""Id"" as NoteId, N.""ParentNoteId"" as ParentNoteId,m.""Name"" as MasterName,m.""DocumentStatus"" as ""DocumentStatus""
...
inner join public.""NtsService"" as s on  s.""UdfNoteTableId"" =ds.""Id"" and   s.""IsDeleted""='false' and s.""CompanyId""='{_userContext.CompanyId}'
        ...
        public async Task<IdNameViewModel> GetPerformanceGradeRatingList(string perRatingId)
        {
        ...
        public async Task<IList<IdNameViewModel>> GetPerformanceGradeRatingListData(string perRatingId)
        {
            var query = $@"SELECT gr.""Name"" as Name, gr.""Id"" as Id
                            FROM  public.""NtsNote"" N
                            inner join cms.""N_General_PerformanceRatingItem"" gr on  N.""Id"" =gr.""NtsNoteId"" and gr.""IsDeleted""=false
                            join public.""NtsNote"" as prn on N.""ParentNoteId""=prn.""Id"" and prn.""IsDeleted""=false
                            join cms.""N_General_PerformanceRating"" as pr on prn.""Id"" = pr.""NtsNoteId"" and pr.""IsDeleted"" = false and pr.""Id"" = '{perRatingId}'
                            where N.""IsDeleted"" = false and N.""Status""=1 ";

            var queryData = await _queryRepo1.ExecuteQueryList(query, null);
            return queryData;
        }
        public async Task<PerformanceDocumentStageViewModel> GetPerformanceDocumentMasterId(string noteId)
        {

            var query = $@"SELECT ds.*, N.""Id"" as NoteId, N.""ParentNoteId"" as ParentNoteId
            FROM  public.""NtsNote"" N
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" ds on  N.""Id"" =ds.""NtsNoteId"" and  ds.""IsDeleted""='false' 
            and ds.""CompanyId""='{_userContext.CompanyId}'
        ...
        public async Task<List<TreeViewViewModel>> GetDiagramMenuItemData(string roleText, string userId)
        ...
        public async Task<List<TreeViewViewModel>> GetDiagramMenuItemUserRoleData(string id, string userRoleId, string userId)
        {
            var query = "";
            query = $@"Select usp.""InboxStageName"" ||' (' || COALESCE(nt.""Count"",0)|| ')' as Name
        ...
        public async Task<List<TreeViewViewModel>> GetDiagramMenuItemPerformanceType(string id, string userRoleId, string userId)
        {
            var query = "";
            query = $@"Select  usp.""TemplateShortName"" ||' (' || COALESCE(t.""Count"",0)|| ')'  as Name,
                usp.""TemplateCode""  as id, '{id}' as ParentId,                
        ...
        public async Task<List<TreeViewViewModel>> GetDiagramMenuItemPerformance(string id, string userId)
        {
            var query = "";
            query = $@"select  s.""Id"" as id,
                s.""ServiceSubject"" ||' (' || COALESCE(t.""Count"",0) || ')' as Name,
        ...
        public async Task<List<PerformanceDiagramViewModel>> GetPerformanceDiagram(string performanceDocumentId)
        {
...
inner join  cms.""N_PerformanceDocument_PMSDevelopment"" as  PG on  s.""UdfNoteId"" =PG.""NtsNoteId"" and PG.""IsDeleted""=false and PG.""CompanyId""='{_userContext.CompanyId}'
            ...
            var list = await _queryRepo1.ExecuteQueryList<PerformanceDiagramViewModel>(query, null);
            return list;
        ...
        public async Task<List<ProjectGanttTaskViewModel>> GetPerformanceDiagramData(string performanceDocumentId)
        {
            var taskquery = $@"
                           WITH RECURSIVE Nts AS(
...
select gns.""Id"" as ServiceId,g.""GoalName"" as GoalName,g.""Id"",g.""Weightage"" as Weightage,g.""IsGoalCompleted"" as IsGoalCompleted,g.""GoalStartDate"" as StartDate,g.""GoalEndDate"" as EndDate
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  and pdm.""IsDeleted""=false
...
";
        ...
        public async Task<IList<GoalViewModel>> GetCompentencyWeightageByPerformanceId(string Id, string stageId, string userId)
        {
            ...
            var query = $@"
select gns.""Id"" as ServiceId,g.""CompetencyName"" as GoalName,g.""Id"",g.""Weightage"" as Weightage,g.""CompetencyStartDate"" as StartDate,g.""CompetencyEndDate"" as EndDate
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  and pdm.""IsDeleted""=false
...
";
        ...
        //public async Task ChangeStatusforDocumentMaster(PerformanceDocumentStatusEnum status, PerformanceDocumentViewModel model)
        //{
        //    var query = $@"update cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" set ""DocumentStatus""='{(int)status}',
        //    ""LastUpdatedBy""='{_userContext.UserId}',""LastUpdatedDate""='{DateTime.Now.ToDatabaseDateFormat()}'
        //    where ""NtsNoteId""='{model.NoteId}'";
        //    await _queryRepo.ExecuteCommand(query, null);
        //}
        //public async Task ChangeStatusforDocumentMasterStage(PerformanceDocumentStatusEnum status, PerformanceDocumentStageViewModel model)
        //{
        //    var query = $@"update cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" set ""DocumentStageStatus""='{(int)status}',
        //    ""LastUpdatedBy""='{_userContext.UserId}',""LastUpdatedDate""='{DateTime.Now.ToDatabaseDateFormat()}'
        //    where ""NtsNoteId""='{model.NoteId}'";
...
left  join cms.""N_CoreHR_HRDepartment"" as hd on hd.""Id""=assi.""DepartmentId"" and hd.""IsDeleted""=false and hd.""CompanyId""='{_userContext.CompanyId}'
 left join cms.""N_CoreHR_HRJob"" as hj on hj.""Id""=assi.""JobId"" and hj.""IsDeleted""=false and hj.""CompanyId""='{_userContext.CompanyId}'
where nt.""ParentNoteId""='{perDocId}' and nt.""TemplateCode""='PERFORMANCE_DOCUMENT_MASTER_USERS' and nt.""IsDeleted""=false and nt.""CompanyId""='{_userContext.CompanyId}' #USER# order by u.""Name""";
...
left  join cms.""N_CoreHR_HRDepartment"" as hd on hd.""Id""=assi.""DepartmentId"" and hd.""IsDeleted""=false and hd.""CompanyId""='{_userContext.CompanyId}'
 left join cms.""N_CoreHR_HRJob"" as hj on hj.""Id""=assi.""JobId"" and hj.""IsDeleted""=false and hj.""CompanyId""='{_userContext.CompanyId}'
where nt.""ParentNoteId""='{perDocId}' and nt.""TemplateCode""='PERFORMANCE_DOCUMENT_MASTER_USERS' and nt.""IsDeleted""=false and nt.""CompanyId""='{_userContext.CompanyId}' order by u.""Name"" ";

            var queryData = await _queryPerDoc.ExecuteQueryList<IdNameViewModel>(query, null);
            return queryData;
        }
...
and pg.""CompetencyStartDate"">='{startDate}' and pg.""CompetencyStartDate""<='{endDate}'
 ...
 ";
        ...
        public async Task<IList<ServiceViewModel>> ReadPerformanceDocumentGoalData(string performanceId, string userId, string masterStageId)
        {
            ...
            ,g.""GoalStartDate"" as ""StartDate"",g.""GoalEndDate"" as DueDate,gns.""ParentServiceId""
            ,u.""Name"" as RequestedByUserName,gns.""CompletedDate"",gns.""ServiceDescription"" ""ServiceDescription"",
            g.""Weightage"" as Weightage,g.""SuccessCriteria"" as SuccessCriteria,mResult.""code"" as ManagerScore
            ,mResult.""Name"" as ManagerScoreValue,r.""ManagerComment"" as ManagerComments
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
			join public.""User"" as u on pdsns.""OwnerUserId""=u.""Id"" and u.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  
            and pds.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId""  
            and pds.""DocumentId""=pd.""Id"" and pd.""IsDeleted""=false
            join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
            join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_GOAL' 
			and gns.""OwnerUserId""=pdsns.""OwnerUserId""  and gns.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSGoal"" as g on gns.""UdfNoteId""=g.""NtsNoteId"" and
            (case when pdms.""EnableReview""='True' and pdms.""PerformanceStageObjective""='1' then pdm.""EndDate""
            when pdms.""EnableReview""='True' and (pdms.""PerformanceStageObjective"" is null or pdms.""PerformanceStageObjective""='2') then pdms.""EndDate""
            else pdm.""EndDate"" end)>=g.""GoalStartDate"" and
            (case when pdms.""EnableReview""='True' and pdms.""PerformanceStageObjective""='1' then pdm.""StartDate""
            when pdms.""EnableReview""='True' and (pdms.""PerformanceStageObjective"" is null or pdms.""PerformanceStageObjective""='2') then pdms.""StartDate""
            else pdm.""StartDate"" end)<=g.""GoalEndDate""   and g.""IsDeleted""=false
			join public.""LOV"" as lov on lov.""Id""=gns.""ServiceStatusId"" and lov.""Code""<> 'SERVICE_STATUS_DRAFT' 
	        and lov.""Code""<> 'SERVICE_STATUS_CANCEL'  and lov.""IsDeleted""=false 
            join cms.""N_PerformanceDocument_PMSStageGoalReview"" r on g.""Id""=r.""GoalId""
            join public.""LOV"" as ss on ss.""Id"" = gns.""ServiceStatusId"" and ss.""IsDeleted""=false
            left join cms.""N_General_PerformanceRatingItem"" as mResult on r.""ManagerRating""=mResult.""Id""  and mResult.""IsDeleted""=false   
            left join public.""LOV"" as sp on sp.""Id"" = gns.""ServicePriorityId"" and sp.""IsDeleted""=false 
            where pds.""IsDeleted""=false and pdms.""Id""='{masterStageId}'and pdsns.""OwnerUserId""='{userId}'";
            var queryData = await _queryTWRepo.ExecuteQueryList<ServiceViewModel>(query, null);
            return queryData;
        }
        public async Task<IList<ServiceViewModel>> ReadPerformanceDocumentCompetencyData(string performanceId, string userId, string masterStageId)
        {
            ...
            ,sp.""Name"" as ""Priority"",ss.""Name"" as ServiceStatusName
            ,g.""CompetencyStartDate"" as ""StartDate"",g.""CompetencyEndDate"" as DueDate,gns.""ParentServiceId""
            ,u.""Name"" as RequestedByUserName,gns.""CompletedDate"",gns.""ServiceDescription"",
            g.""Weightage"" as Weightage,g.""SuccessCriteria"" as SuccessCriteria,mResult.""code"" as ManagerScore
            ,mResult.""Name"" as ManagerScoreValue,r.""ManagerComment"" as ManagerComments
            from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
            join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
            ...
            and pds.""DocumentId""=pd.""Id"" and pd.""IsDeleted""=false
            join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
            join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_COMPENTENCY' 
            and gns.""OwnerUserId""=pdsns.""OwnerUserId""  and gns.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSCompentency"" as g on gns.""UdfNoteId""=g.""NtsNoteId"" and
            (case when pdms.""EnableReview""='True' and pdms.""PerformanceStageObjective""='1' then pdm.""EndDate""
            when pdms.""EnableReview""='True' and (pdms.""PerformanceStageObjective"" is null or pdms.""PerformanceStageObjective""='2') then pdms.""EndDate""
            ...
            join public.""LOV"" as lov on lov.""Id""=gns.""ServiceStatusId"" and lov.""Code""<> 'SERVICE_STATUS_DRAFT' 
            and lov.""Code""<> 'SERVICE_STATUS_CANCEL'  and lov.""IsDeleted""=false 
            join cms.""N_PerformanceDocument_PMSStageCompetencyReview"" r on g.""Id""=r.""CompetencyId""
            join public.""LOV"" as ss on ss.""Id"" = gns.""ServiceStatusId"" and ss.""IsDeleted""=false
            left join cms.""N_General_PerformanceRatingItem"" as mResult
            on r.""ManagerRating""=mResult.""Id""  and mResult.""IsDeleted""=false 
            left join public.""LOV"" as sp on sp.""Id"" = gns.""ServicePriorityId"" and sp.""IsDeleted""=false 
            where pds.""IsDeleted""=false and pdms.""Id""='{masterStageId}'and pdsns.""OwnerUserId""='{userId}'";
            var queryData = await _queryTWRepo.ExecuteQueryList<ServiceViewModel>(query, null);
            return queryData;
        }
        public async Task<List<ServiceViewModel>> TriggerReviewGoal(PerformanceDocumentViewModel user, ServiceTemplateViewModel viewModel)
        {
            var goalquery = @$"
                        select s.*
                        FROM public.""NtsService"" as s 
        ...
        public async Task<List<ServiceViewModel>> TriggerReviewGoalData(PerformanceDocumentViewModel user, ServiceTemplateViewModel viewModel)
        {
            var compquery = @$"
                        select s.*
                        FROM public.""NtsService"" as s 
        ...
        public async Task CalculatePerformanceRatingData(string documentMasterId, string masterStageId, string performanceId, string stageId, string userId)
        {

            var query = $@" with cte as(
            select s.""ServiceNo"",s.""Id"" as ""ServiceId"",pd.""Id"" as ""PerformanceDocumentId""
            ,pds.""Id"" as ""DocumentStageId""
            ...
            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""DocumentMasterId""=pdm.""Id"" and pdms.""IsDeleted""=false
            join cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds on pds.""DocumentMasterStageId""=pdms.""Id"" and pds.""IsDeleted""=false
            and pds.""DocumentMasterId""=pdm.""Id"" and pds.""DocumentId""=pd.""Id"" 
            ...
            left join 
            (
	            select pds.""Id"" as ""DocumentStageId"",sum((coalesce(cast(g.""Weightage"" as float),0))*((coalesce(cast(mResult.""code"" as float),0)/100.00))) as ""Rating""
                from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
                join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  
                ...
                left join cms.""N_General_PerformanceRatingItem"" as mResult
                on r.""ManagerRating""=mResult.""Id""  and mResult.""IsDeleted""=false   
                where pds.""IsDeleted""=false and pdms.""Id""='{masterStageId}'
                group by pds.""Id""
            ) as goal on pds.""Id""=goal.""DocumentStageId""
            left join 
            (
	            select pds.""Id"" as ""DocumentStageId"",sum((coalesce(cast(g.""Weightage"" as float),0))*((coalesce(cast(mResult.""code"" as float),0)/100.00))) as ""Rating""
                from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
                ...
                where pds.""IsDeleted""=false and pdms.""Id""='{masterStageId}'
                group by pds.""Id""
            ) as comp on pds.""Id""=comp.""DocumentStageId""
            where pd.""DocumentMasterId""='{documentMasterId}' 
            and pdms.""Id""='{masterStageId}' and s.""IsDeleted""=false 
            ) update cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" 
            SET ""CalculatedGoalRating"" = cte.""GoalRating"",
            ""CalculatedCompetencyRating"" = cte.""CompRating"",
            ""CalculatedRating"" = round(cast(cte.""CalculatedRating"" as decimal),2),
            ...
            from cte
            where cte.""DocumentStageId""=cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"".""Id""";
        ...
        {
            var query = $@"SELECT  s.""Id"",u.""Name"" as OwnerUserName,u.""Id"" as UserId,pdm.""Year"",pdm.""Name"" as MasterName
            ,ss.""Name"" as ServiceStatusName,pdms.""Name"" as Name,hj.""JobTitle"" as JobName
            , hd.""DepartmentName"" as DepartmentName,hd.""Id"" as DepartmentId
            ,hp.""PersonNo"" as EmployeeNo,s.""ServiceSubject"",ss.""Name"" as ServiceStatusName
            ,goal.""Weightage"" as TotalGoalWeightage,competency.""Weightage"" as TotalCompetencyWeightage
            ,goal.""TotalGoal"" as  ""TotalGoal"",
            goal.""TotalGoalCompleted"" as ""TotalGoalCompleted""
            ,competency.""TotalCompetency"" as ""TotalCompetency"",
            competency.""TotalCompetencyCompleted"" as ""TotalCompetencyCompleted""
            ,pds.""CalculatedRating"" as CalculatedRating,pds.""CalculatedRatingRounded"" as CalculatedRatingRounded
            ,pds.""AdjustedRating"" as AdjustedRating,
            ...
            left join cms.""N_CoreHR_HRJob"" as hj on hj.""Id""=assi.""JobId"" and hj.""IsDeleted""=false and hj.""CompanyId""='{_userContext.CompanyId}'
            left join (
                select pds.""Id"" as ""DocumentStageId"", sum(coalesce(cast(g.""Weightage"" as float),0)) as ""Weightage"",
                count(g.""Id"") as ""TotalGoal"",count(r.""Id"") as ""TotalGoalCompleted""
                from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
                join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  
                and pdm.""Id""=pds.""DocumentMasterId"" and pdm.""IsDeleted""=false
                join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId""  
                and pd.""Id""=pds.""DocumentId"" and pd.""IsDeleted""=false
                join public.""NtsService"" as pdns on pdns.""UdfNoteId""=pd.""NtsNoteId""  and pdns.""IsDeleted""=false
                join public.""NtsService"" as gns on gns.""ParentServiceId""=pdns.""Id"" and gns.""TemplateCode""='PMS_GOAL' 
                and gns.""OwnerUserId""=pdsns.""OwnerUserId""  and gns.""IsDeleted""=false
                join cms.""N_PerformanceDocument_PMSGoal"" as g on gns.""UdfNoteId""=g.""NtsNoteId"" and
                ...
                left join cms.""N_General_PerformanceRatingItem"" as mResult
                on r.""ManagerRating""=mResult.""Id""  and mResult.""IsDeleted""=false   
                where pds.""IsDeleted""=false and pdms.""Id""='{pdmStageId}'
                group by pds.""Id""
            )as goal on pds.""Id""=goal.""DocumentStageId""
            left join(
                select pds.""Id"" as ""DocumentStageId"", sum(coalesce(cast(g.""Weightage"" as float),0)) as ""Weightage"",
                count(g.""Id"") as ""TotalCompetency"",count(r.""Id"") as ""TotalCompetencyCompleted""
                from cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds
                join public.""NtsService"" as pdsns on pdsns.""UdfNoteId""=pds.""NtsNoteId"" and pdsns.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pdms.""Id""=pds.""DocumentMasterStageId"" and pdms.""IsDeleted""=false
                join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id""  
                ...
                where pds.""IsDeleted""=false and pdms.""Id""='{pdmStageId}'
                group by pds.""Id""
            )as ""competency"" on pds.""Id""=competency.""DocumentStageId""
            where tt.""Code""='PMS_PERFORMANCE_DOCUMENT' and s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}'
             
            and pdms.""Id""='{pdmStageId}'";
        ...
        public async Task<List<PerformaceRatingViewModel>> GetPerformanceRatingList()
        {
            ...
            inner join public.""NtsNote"" as N on T.""NtsNoteId""=N.""Id"" and N.""IsDeleted""=false and N.""CompanyId""='{_userContext.CompanyId}'
            where  T.""IsDeleted""=false and T.""CompanyId""='{_userContext.CompanyId}' order by T.""CreatedDate"" desc ";
        ...
        {
            var query = $@"Update cms.""N_PerformanceDocument_PMSCompentency"" set ""IsDeleted""='True' where ""Id""='{Id}'";
            await _queryCompeencyCategory.ExecuteCommand(query, null);
        }
        public async Task DeleteGoal(string Id)
        {
            var query = $@"Update cms.""N_PerformanceDocument_PMSGoal"" set ""IsDeleted""='True' where ""Id""='{Id}'";
            await _queryCompeencyCategory.ExecuteCommand(query, null);
        }
        public async Task DeletService(string Id)
        {
            var query = $@"Update public.""NtsService"" set ""IsDeleted""='True' where ""Id""='{Id}'";
            await _queryCompeencyCategory.ExecuteCommand(query, null);
        }
        public async Task DeleteDevelopment(string Id)
        {
            var query = $@"Update cms.""N_PerformanceDocument_PMSDevelopment"" set ""IsDeleted""='True' where ""Id""='{Id}'";
            await _queryCompeencyCategory.ExecuteCommand(query, null);
        }
...
where s.""OwnerUserId""='{userId}' and pd.""IsDeleted"" = 'false' and pd.""CompanyId""='{_userContext.CompanyId}'";
 ...
 where d.""Id""='{Id}' and i.""IsDeleted""=false order by i.""code""
";
            var data = await _queryRepo1.ExecuteQueryList(query, null);
            return data;
        }
        ...
        public async Task<List<GoalViewModel>> GetParentGoal(string goalId)
        {
...
where s.""IsDeleted""=false and s.""CompanyId""='{_repo.UserContext.CompanyId}' and s.""ParentServiceId""='{pdmId}' and s.""OwnerUserId""= '{ownerUserId}' ";
        ...
        public async Task<IList<ServiceViewModel>> GetPerformanceBookList(string userIds, string docId = null)
        {

            //     string query = $@"select s.""ServiceSubject"", s.""Id"" as Id,ss.""Name"" as ServiceStatusName,s.""ParentServiceId"",
            //                     s.""ServiceDescription"",ss.""Code"" as ServiceStatusCode,s.""ServiceNo"",t.""Code"" as TemplateCode,pd.""Year"",'Document' as ServiceType
            //                     ,'' as MasterStageId,u.""Name"" as OwnerDisplayName
            //                     from public.""NtsService"" as s
            //                     join public.""Template"" as t on t.""Id""=s.""TemplateId"" and t.""Code""='PMS_PERFORMANCE_DOCUMENT' and  t.""IsDeleted""=false and t.""CompanyId""='{_userContext.CompanyId}'
            //                     join public.""LOV"" as ss on s.""ServiceStatusId""=ss.""Id"" and ss.""IsDeleted""=false and ss.""CompanyId""='{_userContext.CompanyId}'
            //                     join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}' 
            //                     join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pd.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_userContext.CompanyId}'
            //                     join public.""User"" as u on s.""OwnerUserId""=u.""Id"" and u.""IsDeleted""=false and u.""CompanyId""='{_userContext.CompanyId}'
            //                     where s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' #USER# #DOCUMENT#
            //                     Union 
            //                     select s.""ServiceSubject"", s.""Id"" as Id,ss.""Name"" as ServiceStatusName,s.""ParentServiceId"",
            //                     s.""ServiceDescription"",ss.""Code"" as ServiceStatusCode,s.""ServiceNo"",t.""Code"" as TemplateCode,pdm.""Year"",'Stage' as ServiceType
            //                     ,pdms.""Id"" as MasterStageId,u.""Name"" as OwnerDisplayName
            //                     from public.""NtsService"" as s
            //                     join public.""Template"" as t on t.""Id""=s.""TemplateId"" and t.""Code""='PMS_PERFORMANCE_DOCUMENT_STAGE' and  t.""IsDeleted""=false and t.""CompanyId""='{_userContext.CompanyId}'
            //                     join public.""LOV"" as ss on s.""ServiceStatusId""=ss.""Id"" and ss.""IsDeleted""=false and ss.""CompanyId""='{_userContext.CompanyId}'
            //                     join cms.""N_PerformanceDocument_PMSPerformanceDocumentStage"" as pds on s.""UdfNoteId"" = pds.""NtsNoteId"" and pds.""IsDeleted""=false and pds.""CompanyId""='{_userContext.CompanyId}' 
            //                     join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMasterStage"" as pdms on pds.""DocumentMasterStageId""=pdms.""Id"" and pdms.""IsDeleted""=false and pdms.""CompanyId""='{_userContext.CompanyId}'
            //join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pdms.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_userContext.CompanyId}'
            //                     join public.""User"" as u on s.""OwnerUserId""=u.""Id"" and u.""IsDeleted""=false and u.""CompanyId""='{_userContext.CompanyId}'
            //                     --join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}'
            //                     --join public.""NtsService"" as ds on pd.""Id""=ds.""UdfNoteTableId"" and ds.""IsDeleted""=false and ds.""CompanyId""='{_userContext.CompanyId}'
            //                     where s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' #USER# --#DOCUMENT#
            //     ";

            string query = $@"With recursive documents as (
                            select s.""ServiceSubject"", s.""Id"" as ""Id"",pd.""DocumentStatus"" as DocumentStatus,s.""ParentServiceId"",
                            s.""ServiceDescription"",ss.""Code"" as ServiceStatusCode,s.""ServiceNo"",t.""Code"" as TemplateCode,pd.""Year"",'Document' as ServiceType
                            ,pdm.""Id"" as MasterStageId,u.""Name"" as OwnerDisplayName
                            from public.""NtsService"" as s
                            join public.""Template"" as t on t.""Id""=s.""TemplateId"" and t.""Code""='PMS_PERFORMANCE_DOCUMENT' and  t.""IsDeleted""=false and t.""CompanyId""='{_userContext.CompanyId}'
                            join public.""LOV"" as ss on s.""ServiceStatusId""=ss.""Id"" and ss.""IsDeleted""=false and ss.""CompanyId""='{_userContext.CompanyId}'
                            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}' 
                            ...
                            where s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' #USER# #DOCUMENT#
                            Union 
                            select s.""ServiceSubject"", s.""Id"" as Id,pds.""DocumentStageStatus"" as DocumentStatus,s.""ParentServiceId"",
                            s.""ServiceDescription"",ss.""Code"" as ServiceStatusCode,s.""ServiceNo"",t.""Code"" as TemplateCode,pdm.""Year"",'Stage' as ServiceType
                            ,pdms.""Id"" as MasterStageId,u.""Name"" as OwnerDisplayName
                            from public.""NtsService"" as s
                            join public.""Template"" as t on t.""Id""=s.""TemplateId"" and t.""Code""='PMS_PERFORMANCE_DOCUMENT_STAGE' and  t.""IsDeleted""=false and t.""CompanyId""='{_userContext.CompanyId}'
                            ...
                            --join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on pdm.""Id""=pd.""DocumentMasterId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_userContext.CompanyId}'
                            --join public.""NtsService"" as ds on pd.""Id""=ds.""UdfNoteTableId"" and ds.""IsDeleted""=false and ds.""CompanyId""='{_userContext.CompanyId}'
                            join documents as d on d.""Id""=s.""ParentServiceId""
                            --where s.""IsDeleted""=false and s.""CompanyId""='{_userContext.CompanyId}' #USER# --#DOCUMENT#
...
";
            ...
            {
                userwhere = $@" and s.""OwnerUserId"" in ('{userIds}') ";
            }
            query = query.Replace("#USER#", userwhere);

            string docwhere = "";
            if (docId.IsNotNullAndNotEmpty())
            {
                docwhere = $@" and s.""Id"" in ('{docId}') ";
            }
            query = query.Replace("#DOCUMENT#", docwhere);

            var queryData = await _queryRepo1.ExecuteQueryList<ServiceViewModel>(query, null);
            var list = queryData.ToList();
            return list;
        }
        ...
        public async Task<List<NtsViewModel>> GetBookList(string serviceId, string templateId, bool includeitemDetails = false)
        {
            ...
            string query = $@"with recursive perbook as (

with recursive perdocument as (
	select t.""DisplayName"" as TemplateName, s.""ServiceSubject"" as Subject, s.""Id"",ss.""Name"" as StatusName,s.""ParentServiceId"" as parentId,t.""SequenceOrder"" as TemplateSequence,
                            s.""ServiceDescription"" as Description,ss.""Code"" as StatusCode,s.""ServiceNo"" as NtsNo,t.""Code"" as TemplateCode,
							u.""Name"" as AssigneeOrOwner,s.""DueDate"",s.""TemplateId"",'1' as ""ItemNo"",'Service' as ""NtsType"",s.""OwnerUserId"" as AssigneeUserId, 1 as ItemType,s.""CreatedDate""
                            from public.""NtsService"" as s
                            join public.""Template"" as t on t.""Id""=s.""TemplateId"" and t.""Code""='PMS_PERFORMANCE_DOCUMENT' and  t.""IsDeleted""=false and t.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join public.""LOV"" as ss on s.""ServiceStatusId""=ss.""Id"" and ss.""IsDeleted""=false and ss.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_repo.UserContext.CompanyId}' 
                            join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pd.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_repo.UserContext.CompanyId}'
							join public.""User"" as u on s.""OwnerUserId""=u.""Id"" and u.""IsDeleted""=false
                            where s.""Id""='{serviceId}' and s.""IsDeleted""=false and s.""CompanyId""='{_repo.UserContext.CompanyId}' --and s.""OwnerUserId""='{_repo.UserContext.UserId}' 
	union all
	
	select t.""DisplayName"" as TemplateName, s.""ServiceSubject"" as Subject, s.""Id"",ss.""Name"" as StatusName,s.""ParentServiceId"" as parentId,t.""SequenceOrder"" as TemplateSequence,
                            s.""ServiceDescription"" as Description,ss.""Code"" as StatusCode,s.""ServiceNo"" as NtsNo,t.""Code"" as TemplateCode,
							u.""Name"" as AssigneeOrOwner,s.""DueDate"",s.""TemplateId"",null as ""ItemNo"",'Service' as ""NtsType"",s.""OwnerUserId"" as AssigneeUserId,
                            case when t.""Code"" = 'PMS_PERFORMANCE_DOCUMENT_STAGE' then 0 else 12 end as ItemType,s.""CreatedDate""
                            from public.""NtsService"" as s
                            join public.""Template"" as t on t.""Id""=s.""TemplateId"" --and t.""Code""='PMS_PERFORMANCE_DOCUMENT_STAGE' and  t.""IsDeleted""=false and t.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join public.""LOV"" as ss on s.""ServiceStatusId""=ss.""Id"" and ss.""IsDeleted""=false and ss.""CompanyId""='{_repo.UserContext.CompanyId}'
                            --join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_repo.UserContext.CompanyId}' 
                            --join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pd.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join public.""User"" as u on s.""OwnerUserId""=u.""Id"" and u.""IsDeleted""=false							
                            join perdocument as d on d.""Id""=s.""ParentServiceId""
	
		)select * from perdocument
	
	union all
	
	select t.""DisplayName"" as TemplateName, s.""TaskSubject"" as Subject, s.""Id"",ts.""Name"" as StatusName,
	case when s.""ParentTaskId"" is null then s.""ParentServiceId"" else s.""ParentTaskId"" end as parentId,t.""SequenceOrder"" as TemplateSequence,
                            s.""TaskDescription"" as Description,ts.""Code"" as StatusCode,s.""TaskNo"" as NtsNo,t.""Code"" as TemplateCode,
							u.""Name"" as AssigneeOrOwner,s.""DueDate"",s.""TemplateId"",null as ""ItemNo"",'Task' as ""NtsType"",s.""AssignedToUserId"" as AssigneeUserId,4 as ItemType,s.""CreatedDate""
                            from public.""NtsTask"" as s
                            join public.""Template"" as t on t.""Id""=s.""TemplateId"" --and t.""Code""='PMS_PERFORMANCE_DOCUMENT_STAGE' and  t.""IsDeleted""=false and t.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join public.""LOV"" as ts on s.""TaskStatusId""=ts.""Id"" and ts.""IsDeleted""=false and ts.""CompanyId""='{_repo.UserContext.CompanyId}'
                            --join cms.""N_PerformanceDocument_PMSPerformanceDocument"" as pd on s.""UdfNoteId"" = pd.""NtsNoteId"" and pd.""IsDeleted""=false and pd.""CompanyId""='{_repo.UserContext.CompanyId}' 
                            --join cms.""N_PerformanceDocumentMaster_PerformanceDocumentMaster"" as pdm on pd.""DocumentMasterId""=pdm.""Id"" and pdm.""IsDeleted""=false and pdm.""CompanyId""='{_repo.UserContext.CompanyId}'
                            join public.""User"" as u on s.""AssignedToUserId""=u.""Id"" and u.""IsDeleted""=false							
                            join perbook as pb on pb.""Id""=s.""ParentServiceId""
        ...
        {
            refIds = refIds.Trim().Replace(",", "','");

            string query = $@"select * from public.""Notification"" where ""ReferenceTypeId"" in ('{refIds}')
and ""ToUserId""='{_userContext.UserId}' ";

            var notifications = await _queryRepo.ExecuteQueryList<NotificationViewModel>(query, null);
        ...
        {
            var query = $@"Select *,""GoalStartDate"" as StartDate,""GoalEndDate"" as DueDate from cms.""N_PerformanceDocument_PMSGoal"" where ""Id""='{id}'";
            return await _queryRepo.ExecuteQuerySingle<GoalViewModel>(query, null);

        }
        public async Task<CompetencyViewModel> GetCompetencyDataById(string id)
        {
            var query = $@"Select *,""CompetencyStartDate"" as StartDate,""CompetencyEndDate"" as DueDate  from cms.""N_PerformanceDocument_PMSCompentency"" where ""Id""='{id}'";
            return await _queryRepo.ExecuteQuerySingle<CompetencyViewModel>(query, null);
        }
        public async Task<CompetencyViewModel> GetDevelopmentDataById(string id)
        {
            var query = $@"Select *,""DevelopmentStartDate"" as StartDate,""DevelopmentEndDate"" as DueDate  from cms.""N_PerformanceDocument_PMSDevelopment"" where ""Id""='{id}'";
            return await _queryRepo.ExecuteQuerySingle<CompetencyViewModel>(query, null);
        }
    }
}
