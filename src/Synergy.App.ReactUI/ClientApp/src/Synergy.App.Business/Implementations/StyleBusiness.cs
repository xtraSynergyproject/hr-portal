...
namespace Synergy.App.Business
{
    public class StyleBusiness : BusinessBase<StyleViewModel, Style>, IStyleBusiness
    {
        ...
        public async override Task<CommandResult<StyleViewModel>> Create(StyleViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<StyleViewModel>> Edit(StyleViewModel model, bool autoCommit = true)
        {
