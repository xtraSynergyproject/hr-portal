...
namespace Synergy.App.Business
{
    public class LOVBusiness : BusinessBase<LOVViewModel, LOV>, ILOVBusiness
    {
        ...
        public async override Task<CommandResult<LOVViewModel>> Create(LOVViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<LOVViewModel>> Edit(LOVViewModel model, bool autoCommit = true)
        {
