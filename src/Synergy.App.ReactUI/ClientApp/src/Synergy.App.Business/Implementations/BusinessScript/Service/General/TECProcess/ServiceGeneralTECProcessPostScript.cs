...
using Synergy.App.Business.Interface.BusinessScript.Service.General.TECProcess;
...
namespace Synergy.App.Business.Implementations.BusinessScript.Service.General.TECProcess
{
