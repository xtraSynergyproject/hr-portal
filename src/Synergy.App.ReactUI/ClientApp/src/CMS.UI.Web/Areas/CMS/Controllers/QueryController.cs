...
namespace CMS.Web.Areas.CMS.Controllers
{
    ...
    public class QueryController : Controller
    {
        ...
        [HttpGet]
        [Route("TableData")]
        public async Task<IActionResult> TableData(string tableName, string columns = null, string filter = null, string orderbyColumns = null, string orderBy = null, string where = null,bool isUnique=false,string uniqueColumns=null,bool ignoreJoins=false, int? limit = null, int? skip = null  )
        {
            try
            {
                ...
                var data = await cmsBusiness.GetData(split[0], split[1], columns, filter, orderbyColumns, OrderByEnum.Ascending, where, ignoreJoins);
        ...
        public async Task<IActionResult> GetLOVIdNameList(string lovType, string parentId)
        {
            try
            {
