...
namespace CMS.UI.Web.Areas.PortalAdmin.Controllers
{
    ...
    public class NotificationTemplateController : ApplicationController
    {
        ...
        public async Task<ActionResult> ReadNotificationlist(DateTime? date, ReferenceTypeEnum? refType = null, bool read = false, bool archive = false, string refTypeId=null, bool completedStatus = false)
        {
