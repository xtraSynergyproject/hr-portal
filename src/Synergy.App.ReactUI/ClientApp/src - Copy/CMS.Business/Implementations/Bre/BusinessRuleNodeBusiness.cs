...
namespace CMS.Business
{
    public class BusinessRuleNodeBusiness : BusinessBase<BusinessRuleNodeViewModel, BusinessRuleNode>, IBusinessRuleNodeBusiness
    {
        ...
        //}
        public async override Task<CommandResult<BusinessRuleNodeViewModel>> Create(BusinessRuleNodeViewModel model)
        {
        ...
        public async override Task<CommandResult<BusinessRuleNodeViewModel>> Edit(BusinessRuleNodeViewModel model)
        {
