...
namespace CMS.Business
{
    public class CustomIndexPageTemplateBusiness : BusinessBase<CustomIndexPageTemplateViewModel, CustomIndexPageTemplate>, ICustomIndexPageTemplateBusiness
    {
        ...
        public async override Task<CommandResult<CustomIndexPageTemplateViewModel>> Create(CustomIndexPageTemplateViewModel model)
        {
        ...
        public async override Task<CommandResult<CustomIndexPageTemplateViewModel>> Edit(CustomIndexPageTemplateViewModel model)
        {
