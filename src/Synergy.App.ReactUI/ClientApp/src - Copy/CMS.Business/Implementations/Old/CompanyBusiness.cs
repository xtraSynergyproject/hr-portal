...
namespace CMS.Business
{
    public class CompanyBusiness : BusinessBase<CompanyViewModel, Company>, ICompanyBusiness
    {
        ...
        public async override Task<CommandResult<CompanyViewModel>> Create(CompanyViewModel model)
        {
        ...
        public async override Task<CommandResult<CompanyViewModel>> Edit(CompanyViewModel model)
        {
            var errorList = new Dictionary<string, string>();
