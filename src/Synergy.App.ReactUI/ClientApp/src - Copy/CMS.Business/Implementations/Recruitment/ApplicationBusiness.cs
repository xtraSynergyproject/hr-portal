...
namespace CMS.Business
{
    public class ApplicationBusiness : BusinessBase<ApplicationViewModel, Application>, IApplicationBusiness
    {
        ...
        public async override Task<CommandResult<ApplicationViewModel>> Create(ApplicationViewModel model)
        {
        ...
        public async override Task<CommandResult<ApplicationViewModel>> Edit(ApplicationViewModel model)
        {
...
#WHERE# ";
        ...
        public async Task UpdateJobAdvtApplicationStatus(string type, string status, string applicationId, string CandidateProfileId, string state)
        {
            if (type == "JobApplication")
            {
                var application = await GetSingleById(applicationId);
        ...
        public async Task<CommandResult<ApplicationViewModel>> CreateApplication(CandidateProfileViewModel model,BatchViewModel batch)
        {
            double sum = 0;
