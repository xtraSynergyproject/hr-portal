...
namespace CMS.Business
{
    public class CandidateLanguageProficiencyBusiness : BusinessBase<CandidateLanguageProficiencyViewModel, CandidateLanguageProficiency>, ICandidateLanguageProficiencyBusiness
    {
        ...
        public async override Task<CommandResult<CandidateLanguageProficiencyViewModel>> Create(CandidateLanguageProficiencyViewModel model)
        {            
        ...
        public async override Task<CommandResult<CandidateLanguageProficiencyViewModel>> Edit(CandidateLanguageProficiencyViewModel model)
        {
            var validateSequenceOrder = await IsExists(model);
            if (!validateSequenceOrder.IsSuccess)
            {
