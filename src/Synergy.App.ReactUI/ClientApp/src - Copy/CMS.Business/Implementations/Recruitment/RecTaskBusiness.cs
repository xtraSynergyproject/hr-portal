...
namespace CMS.Business
{
    public class RecTaskBusiness : BusinessBase<RecTaskViewModel, RecTask>, IRecTaskBusiness
    {
        ...
        public RecTaskBusiness(IRepositoryBase<RecTaskViewModel, RecTask> repo, IMapper autoMapper, IRepositoryQueryBase<RecTaskViewModel> queryRepo,
            ...
            IUserRoleBusiness userRoleBusiness, IMasterBusiness masterBusiness) : base(repo, autoMapper)
        {
        ...
        public async override Task<CommandResult<RecTaskViewModel>> Create(RecTaskViewModel model)
        {
        ...
        public async Task<CommandResult<RecTaskViewModel>> ManageTask(RecTaskViewModel model)
        {
        ...
        public async override Task<CommandResult<RecTaskViewModel>> Edit(RecTaskViewModel model)
        {
