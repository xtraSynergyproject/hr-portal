...
namespace CMS.Business
{
    public class ApplicationLanguageProficiencyBusiness : BusinessBase<ApplicationLanguageProficiencyViewModel, ApplicationLanguageProficiency>, IApplicationLanguageProficiencyBusiness
    {
        ...
        public async override Task<CommandResult<ApplicationLanguageProficiencyViewModel>> Create(ApplicationLanguageProficiencyViewModel model)
        {
        ...
        public async override Task<CommandResult<ApplicationLanguageProficiencyViewModel>> Edit(ApplicationLanguageProficiencyViewModel model)
        {
            var validateSequenceOrder = await IsExists(model);
            if (!validateSequenceOrder.IsSuccess)
            {
