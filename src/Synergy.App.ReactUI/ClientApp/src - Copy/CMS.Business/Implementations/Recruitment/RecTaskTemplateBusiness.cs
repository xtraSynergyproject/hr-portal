...
namespace CMS.Business
{
    public class RecTaskTemplateBusiness : BusinessBase<RecTaskTemplateViewModel, RecTaskTemplate>, IRecTaskTemplateBusiness
    {
        ...
        public async override Task<CommandResult<RecTaskTemplateViewModel>> Create(RecTaskTemplateViewModel model)
        {
        ...
        public async override Task<CommandResult<RecTaskTemplateViewModel>> Edit(RecTaskTemplateViewModel model)
        {
            var data = _autoMapper.Map<RecTaskTemplateViewModel>(model);
            var validateTemplateCode = await IsNameExists(data);
            if (!validateTemplateCode.IsSuccess)
        ...
        public async Task<CommandResult<RecTaskTemplateViewModel>> ManageCreate(RecTaskTemplateViewModel model)
        {
        ...
        public async Task<CommandResult<RecTaskTemplateViewModel>> ManageEdit(RecTaskTemplateViewModel model)
        {
