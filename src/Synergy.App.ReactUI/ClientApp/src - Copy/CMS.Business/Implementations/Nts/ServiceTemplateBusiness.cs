...
namespace CMS.Business
{
    public class ServiceTemplateBusiness : BusinessBase<ServiceTemplateViewModel, ServiceTemplate>, IServiceTemplateBusiness
    {
        ...
        public async override Task<CommandResult<ServiceTemplateViewModel>> Create(ServiceTemplateViewModel model)
        {
        ...
        public async override Task<CommandResult<ServiceTemplateViewModel>> Edit(ServiceTemplateViewModel model)
        {
            var data = _autoMapper.Map<ServiceTemplateViewModel>(model);
