...
namespace CMS.Business
{
    public class NotificationBusiness : BusinessBase<NotificationViewModel, Notification>, INotificationBusiness
    {
        ...
        {
            var query = $@"select n.*, u.""PhotoId"" as PhotoId,concat( u.""Name"",'<',u.""Email"",'>')  as From,nt.""ActionType"" as ActionType,lv.""Code"" as RefStatus
...
where n.""ToUserId""='{userId}'  and n.""IsDeleted""=false and n.""PortalId""='{portalId}' #REFERENCE# #Id#
        ...
        public async Task<IList<NotificationViewModel>> GetAllNotifications(string userId, string portalId)
        {
