...
namespace CMS.Business
{
    public class NtsLogPageColumnBusiness : BusinessBase<NtsLogPageColumnViewModel, NtsLogPageColumn>, INtsLogPageColumnBusiness
    {
        ...
        public async override Task<CommandResult<NtsLogPageColumnViewModel>> Create(NtsLogPageColumnViewModel model)
        {          
        ...
        public async override Task<CommandResult<NtsLogPageColumnViewModel>> Edit(NtsLogPageColumnViewModel model)
        {
