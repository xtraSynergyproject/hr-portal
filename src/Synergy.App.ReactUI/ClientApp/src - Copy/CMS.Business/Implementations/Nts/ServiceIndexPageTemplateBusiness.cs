...
namespace CMS.Business
{
    public class ServiceIndexPageTemplateBusiness : BusinessBase<ServiceIndexPageTemplateViewModel, ServiceIndexPageTemplate>, IServiceIndexPageTemplateBusiness
    {
        ...
        public async override Task<CommandResult<ServiceIndexPageTemplateViewModel>> Create(ServiceIndexPageTemplateViewModel model)
        {          
        ...
        public async override Task<CommandResult<ServiceIndexPageTemplateViewModel>> Edit(ServiceIndexPageTemplateViewModel model)
        {
