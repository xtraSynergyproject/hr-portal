...
namespace CMS.Business
{
    public class TaskTemplateBusiness : BusinessBase<TaskTemplateViewModel, TaskTemplate>, ITaskTemplateBusiness
    {
       ...
       , INotificationTemplateBusiness notificationTemplateBusiness, IRepositoryBase<TableMetadataViewModel, TableMetadata> repo1
        ...
        public async override Task<CommandResult<TaskTemplateViewModel>> Create(TaskTemplateViewModel model)
        {
            ...
            if (model.Json.IsNotNullAndNotEmpty())
            {
                ...
                if (temp.IsNotNull())
                {
                    ...
                    if (table != null)
                    {
                        ...
                        _tableMetadataBusiness.ChildComp(rows, table, 1);
        ...
        public async override Task<CommandResult<TaskTemplateViewModel>> Edit(TaskTemplateViewModel model)
        {
            var data = _autoMapper.Map<TaskTemplateViewModel>(model);
            var errorList = new Dictionary<string, string>();
            var newtablemeta = new TableMetadataViewModel();
        ...
        public async Task<CommandResult<TaskTemplateViewModel>> ManageCreate(TaskTemplateViewModel model)
        {
        ...
        public async Task<CommandResult<TaskTemplateViewModel>> ManageEdit(TaskTemplateViewModel model)
        {
