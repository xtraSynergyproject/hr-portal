...
namespace CMS.Business
{
    public class OCRMappingBusiness : BusinessBase<OCRMappingViewModel, OCRMapping>, IOCRMappingBusiness
    {
        ...
        public async override Task<CommandResult<OCRMappingViewModel>> Create(OCRMappingViewModel model)
        {
        ...
        public async override Task<CommandResult<OCRMappingViewModel>> Edit(OCRMappingViewModel model)
        {
