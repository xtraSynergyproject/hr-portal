...
namespace CMS.Business
{
    public class HierarchyMasterBusiness : BusinessBase<HierarchyMasterViewModel, HierarchyMaster>, IHierarchyMasterBusiness
    {
       ...
       // ITableMetadataBusiness _tableMetadataBusiness;
        ...
        public async override Task<CommandResult<HierarchyMasterViewModel>> Create(HierarchyMasterViewModel model)
        {
        ...
        public async override Task<CommandResult<HierarchyMasterViewModel>> Edit(HierarchyMasterViewModel model)
        {
