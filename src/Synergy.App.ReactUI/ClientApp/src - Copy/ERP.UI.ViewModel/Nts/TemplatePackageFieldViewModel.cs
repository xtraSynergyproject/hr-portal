...
{
    [Serializable]
    public class TemplatePackageFieldViewModel : TemplatePackageFieldConfigViewModel
    {
      
        public long TemplatePackageId { get; set; }
        public TemplateFieldViewModel TemplateField { get; set; }

        public long? TemplateFieldId { get; set; }        

    }
    [Serializable]
    public class TemplatePackageFieldConfigViewModel : ViewModelBase
    {
