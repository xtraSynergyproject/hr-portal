...
{
    public class NoteCommentViewModel : ViewModelBase
    {
        ...
        public string CommentedToUserIds { get; set; }
        public string[] CommentedToUsers { get; set; }
        public string CommentedToUser
        {
            get
            {
                var str = "";
                if (CommentedToUsers != null)
                    str = string.Join(",", CommentedToUsers);
                return str;
            }
        }
        public string CommentToUsers { get; set; }
