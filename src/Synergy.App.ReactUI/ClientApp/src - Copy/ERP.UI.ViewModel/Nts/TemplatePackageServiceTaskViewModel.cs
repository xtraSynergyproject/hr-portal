...
{
    [Serializable]
    public class TemplatePackageServiceTaskViewModel : TemplatePackageServiceTaskConfigViewModel
    {
        public long TemplatePackageId { get; set; }
        public long ServiceTaskTemplateId { get; set; }

        public ServiceTaskTemplateViewModel ServiceTaskTemplate { get; set; }

    }
    [Serializable]
    public class TemplatePackageServiceTaskConfigViewModel : ViewModelBase
    {
