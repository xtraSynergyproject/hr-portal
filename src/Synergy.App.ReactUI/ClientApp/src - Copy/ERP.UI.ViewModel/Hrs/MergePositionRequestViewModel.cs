...
{
    public class MergePositionRequestViewModel : BaseRequestViewModel
    {

        public int Id { get; set; }

        [Required]
        [Display(Name = "Merge To")]
        public int? PositionId { get; set; }


        public IdNameViewModel MergeToPosition { get; set; }


        public int? InitialMergePositionId { get; set; }

        [Display(Name = "Add Merge From Positions")]
        [Required(ErrorMessage = "Atleast select one position to merge from")]
        public string MergeFromPositions { get; set; }

        public List<IdNameViewModel> MergeFromPositionList { get; set; }
