...
namespace CMS.UI.Web.Areas.CMS.Controllers
{
    ...
    public class NtsTaskController : ApplicationController
    {
        ...
        public IActionResult TaskListByFilters(string userId = null, string statusCodes = null, string templateCodes = null, string parentServiceId = null, string parentNoteId = null, bool enableCreate=false)
        {
