        ...
        flowy.endDrag = function (event) {
            ...
            if (event.which != 3 && (active || rearrange)) {
                ...
                if (parseInt(drag.querySelector(".blockid").value) === 0 && rearrange) {
                    ...
                    if (type === 'DecisionScript') {
                        //var tr = document.getElementById('descisionTrueBlock');
                        //console.log(drag);
                        //console.log(tr);
                        //blockSnap(tr, false, drag);
                        //snap(tr, i + 1, blocko + 1);
                        var el = $('#descisionTrueBlock').get(0);
                        var element = document.getElementById('descisionTrueBlock');
                        ...
                        //var mousedownE = new MouseEvent('mousedown', { view: window, cancelable: true, bubbles: true });
                        //el.dispatchEvent(mousedownE);
                        //var mousemoveE = new MouseEvent('mousemove', { view: window, cancelable: true, bubbles: true });
                        //el.dispatchEvent(mousemoveE);

                        //var mouseupE = new MouseEvent('mouseup', { view: window, cancelable: true, bubbles: true });
                        //el.dispatchEvent(mouseupE);
                    }
                } else if (rearrange) {
                    var blocko = blocks.map(a => a.id);
                    for (var i = 0; i < blocks.length; i++) {
