...
function OnMenuClick(e, command, bulkRequestId) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (command == "reqOrg_LEVEL1" || command == "reqOrg_LEVEL2" || command == "reqOrg_LEVEL3" || command == "reqOrg_LEVEL4") {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&DepartmentLevelId=' + levelid);
                    roudfs = encodeURIComponent('DepartmentLevelId=true');
                }
                else if (command == "req_BRAND" || command == "req_MARKET" || command == "req_PROVINCE" || command == "req_DEPARTMENT") {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&DepartmentTypeId=' + levelid);
                    roudfs = encodeURIComponent('DepartmentTypeId=true');
                }
    ...
    //}
        ...
        udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&BulkRequestId=' + bulkRequestId);
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (refType == 'POSITION') {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&PositionId=' + refId + '&DepartmentId=' + data.DepartmentId + '&JobId=' + data.JobId + '&BulkRequestId=' + bulkRequestId);
                    roudfs = encodeURIComponent('DepartmentId=true&JobId=true&PositionId=true');
                } else if (refType == 'JOB') {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&JobId=' + refId + '&BulkRequestId=' + bulkRequestId);
                    roudfs = encodeURIComponent('JobId=true');
                } else {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&DepartmentId=' + refId + '&BulkRequestId=' + bulkRequestId);
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (refType == 'POSITION') {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&PositionId=' + refId + '&DepartmentId=' + data.DepartmentId + '&JobId=' + data.JobId);
                    roudfs = encodeURIComponent('DepartmentId=true&JobId=true&PositionId=true');
                }
                else if (refType == 'JOB') {
                    udfs = encodeURIComponent('BusinessHierarchyParentId=' + orgId + '&JobId=' + refId + '&BulkRequestId=' + bulkRequestId);
