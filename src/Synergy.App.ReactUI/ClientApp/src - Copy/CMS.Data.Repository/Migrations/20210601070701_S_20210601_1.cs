...
{
    public partial class S_20210601_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrantStatus = table.Column<byte>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrantAccess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GrantAccess_User_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrantAccessLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GrantAccessLog_User_UserId",
                        column: x => x.UserId,
                        principalSchema: "public",
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrantAccess_UserId",
                schema: "public",
                table: "GrantAccess",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GrantAccessLog_UserId",
                schema: "log",
