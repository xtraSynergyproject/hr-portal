...
{
    public class TaskIndexPageTemplate : DataModelBase
    {
        ...
        public bool EnableMyTaskTab { get; set; }
        public bool EnableMyTaskSummary { get; set; }

        public bool EnableRequestedByMeTab { get; set; }
        public bool EnableRequestedByMeSummary { get; set; }

        public bool EnableAssignedToMeTab { get; set; }
        public bool EnableAssignedToMeSummary { get; set; }
    ...
    [Table("TaskIndexPageTemplateLog", Schema = "log")]
    public class TaskIndexPageTemplateLog : TaskIndexPageTemplate
    {
