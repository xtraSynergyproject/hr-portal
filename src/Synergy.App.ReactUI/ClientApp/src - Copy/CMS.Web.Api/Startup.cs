    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHttpContextAccessor accessor)
        {
            ...
            try
            {
                ...
                {
                    RecurringJob.AddOrUpdate<CMS.Business.HangfireScheduler>(x => x.ConvertFileToPdf(), Cron.MinuteInterval(5));
                }
            }
            catch (Exception)
            {
            ...
            try
            {
                RecurringJob.AddOrUpdate<CMS.Business.HangfireScheduler>(x => x.DailyJob(), Cron.Daily());
            }
            catch (Exception)
            {
            ...
            try
            {
                ...
                RecurringJob.AddOrUpdate<CMS.Business.HangfireScheduler>(x => x.PerformBackgroundJob("123"), Cron.MinuteInterval(1));
