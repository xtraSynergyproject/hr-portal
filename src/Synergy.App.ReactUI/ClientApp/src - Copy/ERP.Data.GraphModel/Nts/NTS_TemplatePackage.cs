...
{
    public class NTS_TemplatePackage : NTS_TemplatePackageConfig
    {
    ...
    public class R_TemplatePackage_LegalEntity_OrganizationRoot : RelationshipBase
    {

    }
    public class R_TemplatePackage_TemplateCategory : RelationshipBase
    {

    }
    public class R_TemplatePackage_Template : RelationshipBase
    {

    }
    public class NTS_TemplatePackageConfig : NodeBase
    {
        //Header     
