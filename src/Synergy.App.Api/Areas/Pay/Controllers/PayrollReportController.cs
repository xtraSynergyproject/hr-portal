...
{
    [Route("pay/PayrollReport")]
    [ApiController]
    public class PayrollReportController : ApiController
    {
        ...
        public PayrollReportController(AuthSignInManager<ApplicationIdentityUser> customUserManager,
         IServiceProvider serviceProvider, IPayrollBusiness payrollBusiness, ITableMetadataBusiness tableMetadataBusiness,
            ISalaryInfoBusiness businessSalaryInfo, IPayrollRunBusiness payrollRunBusiness, IExcelReportBusiness excelReportBusiness) : base(serviceProvider)
        {
        ...
        [HttpPost]
        [Route("SickLeaveAccrualReportData")]
        public async Task<IActionResult> SickLeaveAccrualReportData(PayrollReportViewModel search = null)
        {
            ...
            var j = Ok(model.OrderBy(o => o.PersonNo));
            return j;
        }

        [HttpGet]
        [Route("SickLeaveAccrual")]
        public async Task<IActionResult> SickLeaveAccrual(string payrollRunId = null, LayoutModeEnum? layoutMode = null, bool disableSearch = false)
        {
            ...
            var model = new PayrollReportViewModel { PayrollRunId = payrollRunId, Year = year, Month = month, YearMonth = yearmonth, DisableSearch = disableSearch };

            return Ok(model);
        }

        [HttpGet]
        [Route("FlightTicketAccrualReportData")]
        ...
        [HttpGet]
        [Route("VacationAccrualReportData")]
        ...
        [HttpGet]
        [Route("FlightTicketAccrualDetailsByDateDataExcel")]
        public async Task<ActionResult> FlightTicketAccrualDetailsByDateDataExcel(int Year, MonthEnum Month, string PersonId)
        {
        ...
        [HttpGet]
        [Route("VacationAccuralDetailsByDateDataExcel")]
        public async Task<ActionResult> VacationAccuralDetailsByDateDataExcel( string PayrollId, int? Year, MonthEnum? Month, string personId)
        {
        ...
        [HttpGet]
        [Route("LoanAccrualDetailsByDateDataExcel")]
        public async Task<ActionResult> LoanAccrualDetailsByDateDataExcel( string personId, int? Year, MonthEnum? month = null)
        {
            var search = new PayrollReportViewModel();
            search.Year = Year ?? DateTime.Today.Year;
            search.Month = month ?? (MonthEnum)DateTime.Today.Month;
        ...
        [HttpGet]
        [Route("AccrualDetailsByDateDataExcel")]
        public async Task<ActionResult> AccrualDetailsByDateDataExcel( string personId, int? Year, MonthEnum? month = null)
        {
            var search = new PayrollReportViewModel();
            search.Year = Year ?? DateTime.Today.Year;
            search.Month = month ?? (MonthEnum)DateTime.Today.Month;
