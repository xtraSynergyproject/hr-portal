...
namespace Synergy.App.Api.Areas.Cms.Controllers
{
    ...
    public class CmsController : ApiController
    {
        ...
        INtsServiceCommentBusiness ntsServiceCommentBusiness, ICmsBusiness cmsBusiness, IServiceBusiness serviceBusiness, INtsTagBusiness ntsTagBusiness, INoteBusiness noteBusiness) : base(serviceProvider)
        {
