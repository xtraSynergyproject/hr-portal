...
{
    [Table("RecTask", Schema = "public")]
    public class RecTask : DataModelBase
    {
        ...
        public string DropdownDisplayValue1 { get; set; }
        public string DropdownDisplayValue2 { get; set; }
        public string DropdownDisplayValue3 { get; set; }
        public string DropdownDisplayValue4 { get; set; }
        public string DropdownDisplayValue5 { get; set; }
        public string DropdownDisplayValue6 { get; set; }
        public string DropdownDisplayValue7 { get; set; }
        public string DropdownDisplayValue8 { get; set; }
        public string DropdownDisplayValue9 { get; set; }
        public string DropdownDisplayValue10 { get; set; }
    }
