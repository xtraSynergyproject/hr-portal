...
{
    public class ServiceIndexPageTemplate : DataModelBase
    {
        ...
        public bool EnableMyServiceTab { get; set; }
        public bool EnableMyServiceSummary { get; set; }
    ...
    [Table("ServiceIndexPageTemplateLog", Schema = "log")]
    public class ServiceIndexPageTemplateLog : ServiceIndexPageTemplate
    {
