...
namespace Synergy.App.Business
{
    public interface IApplicationBusiness : IBusinessBase<ApplicationViewModel, Application>
    {
        ...
        Task<string> UpdateApplicationStatus(string type, string status, string applicationId, string CandidateProfileId, string state, string BatchId, string JobAddId, string JobId,string orgId, bool autoCommit = true);
        ...
        Task UpdateJobAdvtApplicationStatus(string type, string status, string applicationId, string CandidateProfileId, string state, bool autoCommit = true);
        ...
        Task<CommandResult<ApplicationViewModel>> CreateApplication(CandidateProfileViewModel model, BatchViewModel batch, bool autoCommit = true);
        Task<ApplicationViewModel> GetNameById(string applicationId);
        Task<CommandResult<ApplicationViewModel>> UpdateApplication(CandidateProfileViewModel model, bool autoCommit = true);
