...
namespace Synergy.App.Business.Interface.BusinessScript.Service.General.CoreHR
{
    public interface IServiceGeneralCoreHRPostScript
    {
        ...
        Task<CommandResult<ServiceTemplateViewModel>> PostTravelReimbursementToPayroll(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
        Task<CommandResult<ServiceTemplateViewModel>> PostMedicalReimbursementToPayroll(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
        Task<CommandResult<ServiceTemplateViewModel>> PostEducationalReimbursementToPayroll(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
        Task<CommandResult<ServiceTemplateViewModel>> PostOtherReimbursementToPayroll(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
        Task<CommandResult<ServiceTemplateViewModel>> PostCRPFTransferRequest(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
        Task<CommandResult<ServiceTemplateViewModel>> AddStockIndividualTransferDetails(ServiceTemplateViewModel viewModel, dynamic udf, IUserContext uc, IServiceProvider sp);
