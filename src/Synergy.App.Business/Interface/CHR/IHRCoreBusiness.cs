...
namespace Synergy.App.Business
{
    public interface IHRCoreBusiness : IBusinessBase<NoteViewModel, NtsNote>
    {
        ...
        Task<List<PositionChartViewModel>> GetPositionHierarchy(string parentId, int levelUpto, bool? enableTask = null, string categoryCodes = null, string templateCodes = null, string portalNames = null);
        ...
        Task<PagedList<IdNameViewModel>> GetPersonFilterdList(string filters, int pageSize, int pageNumber, string indexItem = null);
        ...
        Task<AssignmentViewModel> GetUserPerformanceDocumentInfo(string userId,string PerformanceId,string MasterStageId);
        ...
        Task<bool> ValidateUserGuideSequenceNo(PostMessageViewModel model);
       ...
       // Task<IList<AccessLogViewModel>> GetAccessLogList(string Id);
        ...
        Task<PagedList<IdNameViewModel>> GetFilteredPersonListByOrgId(string filter, int pageSize, int pageNumber, string indexedItemId = null);
        ...
        Task<IList<NoteViewModel>> GetGroupMessageNew(EndlessScrollingRequest searchModel);
        ...
        Task<PagedList<IdNameViewModel>> GetNonExistingPositionList(string hierarchyId, string positionId, string filter, int pageSize,int pageNumber, string indexedItemId = null);

        Task<PagedList<IdNameViewModel>> GetNonExistingDepartmentList(string hierarchyId, string excludingPositionId, string filter, int pageSize, int pageNumber, string indexedItemId = null);
        Task<PagedList<AssignmentViewModel>> GetPersonAssignmentDetails(string filter, int pageSize, int pageNumber, string indexedItemId = null, string legalEntityId = null);
        Task<List<AssignmentViewModel>> GetEmployeeDirectory();
        Task<List<IdNameViewModel>> GetNonExistingUserInHierarchy(string hierarchyId, string userId);
        Task<List<IdNameViewModel>> GetExistingUserInHierarchyExceptChild(string hierarchyId, string userId);
        Task<UserViewModel> GetManagerData();
        Task<List<TravelReimbursementViewModel>> GetTravelReimbursementbyOwneruserId(string Id);
        Task<List<TravelReimbursementViewModel>> GetMedicalReimbursementbyOwneruserId(string Id);
        Task<List<TravelReimbursementViewModel>> GetEducationalReimbursementbyOwneruserId(string Id);
        Task<List<HRPolicyViewModel>> GetPolicyDocs(string Id);
        Task<List<TravelReimbursementViewModel>> GetOtherReimbursementbyOwneruserId(string Id);
        Task<List<ServiceViewModel>> GetTransferDetails(string Id);
        Task<List<EmployeeTransferItemViewModel>> GetEmployeeTransferItemList(string employeeId);
        Task<List<EmployeeTransferItemViewModel>> GeEmployeeFormTransferItemList(string employeeId);
        Task<List<PostMessageViewModel>> GetUserGuideData();
    }
}
