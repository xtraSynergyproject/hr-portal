...
namespace Synergy.App.Business
{
    public class ApplicationComputerProficiencyBusiness : BusinessBase<ApplicationComputerProficiencyViewModel, ApplicationComputerProficiency>, IApplicationComputerProficiencyBusiness
    {
        ...
        public async override Task<CommandResult<ApplicationComputerProficiencyViewModel>> Create(ApplicationComputerProficiencyViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<ApplicationComputerProficiencyViewModel>> Edit(ApplicationComputerProficiencyViewModel model, bool autoCommit = true)
        {
