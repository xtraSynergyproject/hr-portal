...
namespace Synergy.App.Business
{
    public class ApplicationJobCriteriaBusiness : BusinessBase<ApplicationJobCriteriaViewModel, ApplicationJobCriteria>, IApplicationJobCriteriaBusiness
    {
        ...
        public async override Task<CommandResult<ApplicationJobCriteriaViewModel>> Create(ApplicationJobCriteriaViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<ApplicationJobCriteriaViewModel>> Edit(ApplicationJobCriteriaViewModel model, bool autoCommit = true)
        {
            //var data = _autoMapper.Map<JobCriteriaViewModel>(model);
            //var validateName = await IsNameExists(data);
            //if (!validateName.IsSuccess)
