...
namespace Synergy.App.Business
{
    public class CandidateComputerProficiencyBusiness : BusinessBase<CandidateComputerProficiencyViewModel, CandidateComputerProficiency>, ICandidateComputerProficiencyBusiness
    {
        ...
        public async override Task<CommandResult<CandidateComputerProficiencyViewModel>> Create(CandidateComputerProficiencyViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<CandidateComputerProficiencyViewModel>> Edit(CandidateComputerProficiencyViewModel model, bool autoCommit = true)
        {
