...
namespace Synergy.App.Business
{
    public class ManpowerRecruitmentSummaryBusiness : BusinessBase<ManpowerRecruitmentSummaryViewModel, ManpowerRecruitmentSummary>, IManpowerRecruitmentSummaryBusiness
    {
        ...
        public async override Task<CommandResult<ManpowerRecruitmentSummaryViewModel>> Create(ManpowerRecruitmentSummaryViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<ManpowerRecruitmentSummaryViewModel>> Edit(ManpowerRecruitmentSummaryViewModel model, bool autoCommit = true)
        {
