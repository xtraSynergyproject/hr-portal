...
namespace Synergy.App.Business
{
    public class PushNotificationBusiness : BusinessBase<NotificationViewModel, Notification>, IPushNotificationBusiness
    {
        ...
        public PushNotificationBusiness(IRepositoryBase<NotificationViewModel, Notification> repo, IMapper autoMapper,
            ...
            , ICmsQueryBusiness cmsQueryBusiness,IRepositoryQueryBase<NotificationViewModel> appqueryRepo) : base(repo, autoMapper)
        {
        ...
        //}
        public async override Task<CommandResult<NotificationViewModel>> Edit(NotificationViewModel model, bool autoCommit = true)
        {
        ...
        {
            await _cmsQueryBusiness.SetAllNotificationReadData(userId);
        }
        public async Task SetAllTaskNotificationRead(string userId, string taskId)
        {
            await _cmsQueryBusiness.SetAllTaskNotificationReadData(userId, taskId);
        }
        ...
        {
            var data = await _cmsQueryBusiness.GetNotificationListData(userId);
            return data;
        }
