...
namespace Synergy.App.Business
{
    public class TeamUserBusiness : BusinessBase<TeamUserViewModel, TeamUser>, ITeamUserBusiness
    {
        ...
        public async override Task<CommandResult<TeamUserViewModel>> Create(TeamUserViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<TeamUserViewModel>> Edit(TeamUserViewModel model, bool autoCommit = true)
        {
