...
namespace Synergy.App.Business
{
    public class DecisionScriptComponentBusiness : BusinessBase<DecisionScriptComponentViewModel, DecisionScriptComponent>, IDecisionScriptComponentBusiness
    {
        ...
        public async override Task<CommandResult<DecisionScriptComponentViewModel>> Create(DecisionScriptComponentViewModel model, bool autoCommit = true)
        {
        ...
        public async override Task<CommandResult<DecisionScriptComponentViewModel>> Edit(DecisionScriptComponentViewModel model, bool autoCommit = true)
        {
