...
namespace CMS.UI.Web.Areas.PortalAdmin.Controllers
{
    ...
    public class TagCategoryController : ApplicationController
    {
     ...
     , INoteBusiness noteBusiness, ICmsBusiness cmsBusiness, INtsTagBusiness ntsTagBusiness)
        ...
        public async Task<ActionResult> ReadTagCategoryData([DataSourceRequest] DataSourceRequest request, PerformanceDocumentViewModel search = null)
        {
        ...
        public async Task<JsonResult> SyncTags(string CategoryId)
        {
            ...
            BackgroundJob.Enqueue<HangfireScheduler>(x => x.GenerateTagsForCategory(CategoryId,_userContext.ToIdentityUser()));
            return Json(new { success = true });
        }
