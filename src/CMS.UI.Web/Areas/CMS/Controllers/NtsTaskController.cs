...
namespace CMS.UI.Web.Areas.CMS.Controllers
{
    ...
    public class NtsTaskController : ApplicationController
    {
        ...
        public IActionResult TaskListByFilters(string userId = null, string statusCodes = null, string templateCodes = null, string parentServiceId = null, string parentNoteId = null, bool enableCreate=false,string cbm=null)
        {
        ...
        public async Task<IActionResult> ReadTaskList(string templateCodes = null, string moduleCodes = null, string catCodes = null, string statusCodes = null, string parentServiceId = null,string userId=null, string parentNoteId = null)
        {
        ...
        public async Task<IActionResult> TaskListDashboard(string categoryCodes, string portal)
        {
