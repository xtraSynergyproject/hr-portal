...
namespace CMS.Business
{
    public interface IPerformanceManagementBusiness : IBusinessBase<ServiceViewModel, NtsService>
    {
       ...
       Task<PerformaceRatingViewModel> IsRatingNameExist(string Name, string Id);
        ...
        Task UpdatePerformanceDocumentMasterStageStatus(string Id, PerformanceDocumentStatusEnum status);
        Task UpdatePerformanceDocumentMasterStatus(string Id, PerformanceDocumentStatusEnum status);
