...
namespace CMS.Business
{
    public interface INoteBusiness : IBusinessBase<NoteViewModel, NtsNote>
    {
        ...
        Task<DataTable> GetNoteIndexPageGridData(DataSourceRequest request, string indexPageTemplateId, NtsActiveUserTypeEnum ownerType, string noteStatusCode, string userId = null);
