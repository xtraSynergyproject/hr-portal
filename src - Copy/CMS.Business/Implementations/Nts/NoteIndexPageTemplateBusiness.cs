...
namespace CMS.Business
{
    public class NoteIndexPageTemplateBusiness : BusinessBase<NoteIndexPageTemplateViewModel, NoteIndexPageTemplate>, INoteIndexPageTemplateBusiness
    {
        ...
        public async override Task<CommandResult<NoteIndexPageTemplateViewModel>> Create(NoteIndexPageTemplateViewModel model)
        {
        ...
        public async override Task<CommandResult<NoteIndexPageTemplateViewModel>> Edit(NoteIndexPageTemplateViewModel model)
        {
