...
namespace CMS.Business
{
    public class RecruitmentElementBusiness : BusinessBase<RecruitmentCandidateElementInfoViewModel, RecruitmentCandidateElementInfo>, IRecruitmentElementBusiness
    {
        ...
        public async override Task<CommandResult<RecruitmentCandidateElementInfoViewModel>> Create(RecruitmentCandidateElementInfoViewModel model)
        {
        ...
        public async override Task<CommandResult<RecruitmentCandidateElementInfoViewModel>> Edit(RecruitmentCandidateElementInfoViewModel model)
        {
            //var data = _autoMapper.Map<JobAdvertisementViewModel>(model);
            //var validateName = await IsNameExists(data);
            //if (!validateName.IsSuccess)
