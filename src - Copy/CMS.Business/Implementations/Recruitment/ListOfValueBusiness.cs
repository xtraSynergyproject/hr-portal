...
namespace CMS.Business
{
    public class ListOfValueBusiness : BusinessBase<ListOfValueViewModel, ListOfValue>, IListOfValueBusiness
    {
        ...
        public async override Task<CommandResult<ListOfValueViewModel>> Create(ListOfValueViewModel model)
        {           
        ...
        public async override Task<CommandResult<ListOfValueViewModel>> Edit(ListOfValueViewModel model)
        {
