...
{
    public partial class S_20210802_2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UserGroupUserLog",
                schema: "log",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroupUserLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGroupUserLog_User_UserId",
                        column: x => x.UserId,
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroupUserLog_UserGroup_UserGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGroupUserLog_UserGroupId",
                schema: "log",
                table: "UserGroupUserLog",
                column: "UserGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupUserLog_UserId",
                schema: "log",
                table: "UserGroupUserLog",
                column: "UserId");
        }
