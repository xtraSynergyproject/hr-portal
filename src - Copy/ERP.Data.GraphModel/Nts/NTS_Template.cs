...
namespace ERP.Data.GraphModel
{
    ...
    public partial class NTS_Template : NodeDatedBase
    {
        [NotMapped]
        ...
        public string StepTaskTemplateCode { get; set; }
        ...
        {
            return base.IsActive(asofDate) && DocumentStatus == DocumentStatusEnum.Published;
        }
    ...
    public class R_TemplateRoot : RelationshipDatedBase
    {

    }
    public class R_Template_AssignedTo_User : RelationshipBase
    {

    }
    public class R_Template_AssignedTo_Team : RelationshipBase
    {

    }
    public class R_Template_AssignedTo_Hierarchy : RelationshipBase
    {

    }
    public class R_Template_AssignedTo_HierarchyLevel : RelationshipBase
    {

    }
    public class R_Template_AllowedStepTask_TemplateMaster : RelationshipBase
    {

    }

    public class R_Template_AllowedStepService_TemplateMaster : RelationshipBase
    {

    }

    public class R_Template_Owner_Team : RelationshipBase
    {

    }
    public class R_Template_Owner_User : RelationshipBase
    {

    }
    public class R_Template_Hierarchy : RelationshipBase
    {

    }
    public class R_Template_Workflow_ServiceTemplateMaster : RelationshipBase
    {

    }
    public class R_Template_WorkflowStep_Note : RelationshipBase
    {

    }
    public class R_Template_WorkflowStage_Note : RelationshipBase
    {

    }
    public class R_Template_Reference_TemplateMaster : RelationshipBase
    {
        public TemplateMasterTypeEnum NtsType { get; set; }
    }
}
