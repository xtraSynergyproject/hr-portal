...
function OnMenuClick(e) {    
    ...
    var command = $(e.item).attr('id');      
       ...
       if (command == "CreateNewOrganization") {
           ...
           var url = '/Cms/Page?lo=Popup&source=Create&cbm=OnAfterCreate&dataAction=Create&pageName=Department&portalId=' + portalId + '&udfs=' + udfs;  
           ...
           //     rsv = encodeURIComponent("/hrs/organizationchartexcel/index?a=1");
           //}  
           //iframeOpenUrl = "/hrs/organization/history?OrgId=" + orgId + "&hierarchyid=2&ru=" + rsv;
           //OpenIframePopup(stdWidth, stdHeight, "Manage Department");
           var portalId = $('#GlobalPortalId').val();
           var url = '/Cms/Page?lo=Popup&source=Versioning&cbm=OnAfterCreate&dataAction=Edit&pageName=Department&portalId=' + portalId + '&recordId=' + noteId; 
           ...
           var portalId = $('#GlobalPortalId').val();
           var url = '/Cms/Page?lo=Popup&source=Versioning&cbm=OnAfterCreate&dataAction=Edit&templateCodes=HRDepartmentHierarchy&portalId=' + portalId + '&recordId=' + orgHierarchyNoteId;
           var win = GetMainWindow();
           win.iframeOpenUrl = url;
           ...
           var url = "/chr/OrganizationHierarchy/AddExistingDepartment?parentDepartmentId=" + orgId + "&parentDepartmentName=" + orgName;
           var win = GetMainWindow();
           win.iframeOpenUrl = url;
