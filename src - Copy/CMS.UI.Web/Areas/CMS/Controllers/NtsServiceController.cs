...
namespace CMS.UI.Web.Areas.CMS.Controllers
{
    ...
    public class NtsServiceController : ApplicationController
    {
        ...
        public IActionResult ServiceTemplateTiles(string templateCode, string categoryCode, string userId, string moduleCodes, string prms, string cbm, string templateIds, string categoryIds, TemplateCategoryTypeEnum categoryType = TemplateCategoryTypeEnum.Standard)
        {
            var model = new TemplateViewModel();
            model.Code = templateCode;
            model.CategoryCode = categoryCode;
        ...
        public async Task<IActionResult> ServiceDashboard()
        {
            ProjectDashboardViewModel model = new ProjectDashboardViewModel();
            return View(model);
        }
        ...
        public async Task<ActionResult> GetRequestSLA(ServiceSearchViewModel search = null)
        {
            if (search.StartDate != null && search.DueDate != null)
            {
                search.UserId = _userContext.UserId;
        ...
        public async Task<IActionResult> GetInternalDashboardServiceList([DataSourceRequest] DataSourceRequest request, ServiceSearchViewModel search = null, string categoryCodes = null, string templateCodes = null)
        {
        ...
        public async Task<ActionResult> GetExternalUserExternalServiceSLA(ServiceSearchViewModel search = null)
        {
            if (search.StartDate != null && search.DueDate != null)
            {
                search.UserId = _userContext.UserId;
        ...
        public async Task<IActionResult> GetExternalUserSEBIServiceList(/*[DataSourceRequest] DataSourceRequest request,*/List<string> ServiceStatusIds, ServiceSearchViewModel search = null)
        {
        ...
        public async Task<IActionResult> GenerateServiceWorkFlowDiagramNodesView(List<DiagramNode> Nodes, string id, bool isTemplate = false, List<DiagramConnector> Connectors = null)
        {
            ...
            else
            {
                ...
                var serviceTemplate = result.Where(x => x.Type == "Service").FirstOrDefault();
        ...
        public IActionResult ServiceListByFilters(string userId = null, string statusCodes = null, string templateCodes = null, string parentServiceId = null)
        {
        ...
        public IActionResult ServiceBookList(string templateCodes, string permissions, string bookId)
        {
            ViewBag.TemplateCodes = templateCodes;
            ViewBag.Permissions = permissions;
        ...
        public async Task<IActionResult> ServiceBookBrowse(string bookId, string pageId, string permissions,string ru)
        {            
