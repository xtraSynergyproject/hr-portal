...
namespace ERP.UI.ViewModel
{
    public class UserReportViewModel : ViewModelBase
    {
        ...
        public double? ResultOfTechnicalAssessment { get; set; }
        public double? ResultOfCaseStudy { get; set; }
        ...
        public string MentalAbilityResult { get; set; }
        public string MentalAbilityResultAr { get; set; }

        public string LeadershipResult { get; set; }
        public string LeadershipResultAr { get; set; }
